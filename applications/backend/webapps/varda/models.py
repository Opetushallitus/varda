...
class Organisaatio(HistoryAbstractModel):
    ...
    organisaatio_oid = models.CharField(
        max_length=50, unique=True, blank=True, null=True, validators=[validators.validate_organisaatio_oid]
    )
    ...
    ipv4_osoitteet = ArrayField(
        models.CharField(max_length=20, blank=True, validators=[validators.validate_ipv4_address]), blank=True, null=True
    )
    ipv6_osoitteet = ArrayField(
        models.CharField(max_length=50, blank=True, validators=[validators.validate_ipv6_address]), blank=True, null=True
    )
...
class Toimipaikka(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    kayntiosoite_postinumero = models.CharField(
        max_length=10, blank=False, validators=[validators.validate_postinumero_toimipaikka]
    )
    ...
    kasvatusopillinen_jarjestelma_koodi = models.CharField(
        max_length=100, blank=False, validators=[validators.validate_kasvatusopillinen_jarjestelma_koodi]
    )
    toimintamuoto_koodi = models.CharField(max_length=50, blank=False, validators=[validators.validate_toimintamuoto_koodi])
    toimintakieli_koodi = ArrayField(
        models.CharField(max_length=50, blank=False, validators=[validators.validate_kieli_koodi]),
        blank=False,
        validators=[validators.validate_arrayfield],
    )
    jarjestamismuoto_koodi = ArrayField(
        models.CharField(max_length=50, validators=[validators.validate_jarjestamismuoto_koodi]),
        blank=False,
        validators=[validators.validate_arrayfield],
    )
    ...
    paattymis_pvm = models.DateField(default=None, blank=True, null=True)
    hallinnointijarjestelma = models.CharField(
        choices=Hallinnointijarjestelma.choices(), max_length=50, default=Hallinnointijarjestelma.VARDA
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            UniqueConstraint(
                fields=["lahdejarjestelma", "tunniste"],
...
class ToiminnallinenPainotus(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    toimintapainotus_koodi = models.CharField(
        max_length=6, blank=False, null=False, validators=[validators.validate_toimintapainotus_koodi]
    )
    alkamis_pvm = models.DateField(blank=False, null=False)
    paattymis_pvm = models.DateField(default=None, blank=True, null=True)
    lahdejarjestelma = models.CharField(null=True, max_length=2, validators=[validators.validate_lahdejarjestelma_koodi])
...
class KieliPainotus(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    kielipainotustyyppi_koodi = models.CharField(
        max_length=4, blank=False, null=True, validators=[validators.validate_kielipainotustyyppi_koodi]
    )
    alkamis_pvm = models.DateField(blank=False, null=False)
    paattymis_pvm = models.DateField(default=None, blank=True, null=True)
    lahdejarjestelma = models.CharField(null=True, max_length=2, validators=[validators.validate_lahdejarjestelma_koodi])
...
class Henkilo(HistoryAbstractModel):
    ...
    henkilotunnus_unique_hash = models.CharField(
        max_length=80, blank=True
    )  # This is used for checking uniqueness (64 characters)
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(
                fields=["henkilotunnus_unique_hash"],
                condition=~Q(henkilotunnus_unique_hash=""),
                name="henkilo_henkilotunnus_unique_hash_unique_constraint",
            ),
            UniqueConstraint(fields=["henkilo_oid"], condition=~Q(henkilo_oid=""), name="henkilo_oid_unique_constraint"),
        ]
...
class Lapsi(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    oma_organisaatio = models.ForeignKey(
        Organisaatio, related_name="paos_lapsi_oma_organisaatio", on_delete=models.PROTECT, null=True
    )
    paos_organisaatio = models.ForeignKey(
        Organisaatio, related_name="paos_lapsi_paos_organisaatio", on_delete=models.PROTECT, null=True
    )
    ...
    class Meta:
        ...
        constraints = [
            CheckConstraint(check=~Q(oma_organisaatio=F("paos_organisaatio")), name="oma_organisaatio_is_not_paos_organisaatio"),
            UniqueConstraint(
                fields=["henkilo", "vakatoimija"],
                condition=Q(vakatoimija__isnull=False),
                name="lapsi_vakatoimija_unique_constraint",
            ),
            UniqueConstraint(
                fields=["henkilo", "oma_organisaatio", "paos_organisaatio"],
...
class Varhaiskasvatuspaatos(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    tuntimaara_viikossa = models.DecimalField(
        max_digits=4, decimal_places=1, blank=False, null=False, validators=[MinValueValidator(1.0), MaxValueValidator(120.0)]
    )
...
class Varhaiskasvatussuhde(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    varhaiskasvatuspaatos = models.ForeignKey(
        Varhaiskasvatuspaatos, related_name="varhaiskasvatussuhteet", on_delete=models.PROTECT
    )
    alkamis_pvm = models.DateField(blank=False, null=False, validators=[validators.validate_vaka_date])
    paattymis_pvm = models.DateField(default=None, blank=True, null=True, validators=[validators.validate_vaka_date])
    lahdejarjestelma = models.CharField(null=True, max_length=2, validators=[validators.validate_lahdejarjestelma_koodi])
...
class Maksutieto(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    palveluseteli_arvo = models.DecimalField(
        max_digits=6, decimal_places=2, default=0.00, blank=True, null=True, validators=[MinValueValidator(0.0)]
    )
    asiakasmaksu = models.DecimalField(
        max_digits=6, decimal_places=2, blank=False, null=False, validators=[MinValueValidator(0.0)]
    )
...
class Huoltajuussuhde(HistoryAbstractModel):
    ...
    maksutiedot = models.ManyToManyField(
        Maksutieto, related_name="huoltajuussuhteet", through="MaksutietoHuoltajuussuhde", blank=True
    )
    luonti_pvm = models.DateTimeField(auto_now_add=True)
    muutos_pvm = models.DateTimeField(auto_now=True)
...
class PaosToiminta(HistoryAbstractModel):
    oma_organisaatio = models.ForeignKey(Organisaatio, related_name="paos_toiminnat_oma_organisaatio", on_delete=models.PROTECT)
    paos_organisaatio = models.ForeignKey(
        Organisaatio, related_name="paos_toiminnat_paos_organisaatio", on_delete=models.PROTECT, null=True, blank=True
    )
    paos_toimipaikka = models.ForeignKey(
        Toimipaikka, related_name="paos_toiminnat_paos_toimipaikka", on_delete=models.PROTECT, null=True, blank=True
    )
    voimassa_kytkin = models.BooleanField(default=True)
    luonti_pvm = models.DateTimeField(auto_now_add=True)
    muutos_pvm = models.DateTimeField(auto_now=True)
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(
                fields=["oma_organisaatio", "paos_organisaatio"], name="oma_organisaatio_paos_organisaatio_unique_constraint"
            ),
            UniqueConstraint(
                fields=["oma_organisaatio", "paos_toimipaikka"], name="oma_organisaatio_paos_toimipaikka_unique_constraint"
            ),
        ]


class PaosOikeus(HistoryAbstractModel):
    jarjestaja_kunta_organisaatio = models.ForeignKey(
        Organisaatio, related_name="paos_oikeudet_jarjestaja_kunta", on_delete=models.PROTECT
    )
    tuottaja_organisaatio = models.ForeignKey(Organisaatio, related_name="paos_oikeudet_tuottaja", on_delete=models.PROTECT)
    tallentaja_organisaatio = models.ForeignKey(
        Organisaatio, related_name="paos_oikeudet_tallentaja_organisaatio", on_delete=models.PROTECT
    )
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(
                fields=["jarjestaja_kunta_organisaatio", "tuottaja_organisaatio"],
                name="jarjestaja_kunta_organisaatio_tuottaja_organisaatio_unique_constraint",
            ),
            CheckConstraint(
                check=~Q(jarjestaja_kunta_organisaatio=F("tuottaja_organisaatio")),
...
class Palvelussuhde(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    tyoaika_viikossa = models.DecimalField(
        max_digits=5, decimal_places=2, validators=[MinValueValidator(0.0), MaxValueValidator(50.0)]
    )
    alkamis_pvm = models.DateField(validators=[validators.validate_palvelussuhde_alkamis_pvm])
    paattymis_pvm = models.DateField(
        default=None, blank=True, null=True, validators=[validators.validate_palvelussuhde_paattymis_pvm]
    )
    lahdejarjestelma = models.CharField(max_length=2, validators=[validators.validate_lahdejarjestelma_koodi])
    tunniste = models.CharField(null=True, blank=True, max_length=120, validators=[validators.validate_tunniste])
    luonti_pvm = models.DateTimeField(auto_now_add=True)
...
class Tyoskentelypaikka(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    toimipaikka = models.ForeignKey(
        Toimipaikka, blank=True, null=True, related_name="tyoskentelypaikat", on_delete=models.PROTECT
    )
...
class PidempiPoissaolo(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    alkamis_pvm = models.DateField()
    paattymis_pvm = models.DateField(
        default=paattymis_pvm_default, validators=[validators.validate_pidempi_poissaolo_paattymis_pvm]
    )
    lahdejarjestelma = models.CharField(max_length=2, validators=[validators.validate_lahdejarjestelma_koodi])
    tunniste = models.CharField(null=True, blank=True, max_length=120, validators=[validators.validate_tunniste])
    luonti_pvm = models.DateTimeField(auto_now_add=True)
...
class Taydennyskoulutus(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    koulutuspaivia = models.DecimalField(
        max_digits=4, decimal_places=1, validators=[validators.create_validate_decimal_steps("0.5"), MaxValueValidator(160)]
    )
    lahdejarjestelma = models.CharField(max_length=2, validators=[validators.validate_lahdejarjestelma_koodi])
    tunniste = models.CharField(null=True, blank=True, max_length=120, validators=[validators.validate_tunniste])
    luonti_pvm = models.DateTimeField(auto_now_add=True)
...
class TaydennyskoulutusTyontekija(HistoryAbstractModel):
    ...
    taydennyskoulutus = models.ForeignKey(
        Taydennyskoulutus, related_name="taydennyskoulutukset_tyontekijat", on_delete=models.PROTECT
    )
...
class Aikaleima(AbstractModel):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=["avain", "organisaatio"], name="avain_organisaatio_unique_constraint"),
            # avain_organisaatio_unique_constraint is not checked if organisaatio is None
            UniqueConstraint(
                fields=["avain"], condition=Q(organisaatio__isnull=True), name="avain_organisaatio_is_null_unique_constraint"
            ),
        ]
...
class BatchError(AbstractModel):
    ...
    type = models.TextField(choices=BatchErrorType.choices(), null=False)
...
class LoginCertificate(AbstractModel):
    organisaatio = models.ForeignKey(
        Organisaatio, null=True, default=None, related_name="logincertificates", on_delete=models.PROTECT
    )
...
class Z2_Code(AbstractModel):
    ...
    class Meta:
        ...
        constraints = [models.UniqueConstraint(fields=["koodisto", "code_value"], name="koodisto_code_value_unique_constraint")]
...
class Z2_CodeTranslation(AbstractModel):
    ...
    class Meta:
        ...
        constraints = [models.UniqueConstraint(fields=["code", "language"], name="code_language_unique_constraint")]
...
class Z3_AdditionalCasUserFields(AbstractModel):
    ...
    huollettava_oid_list = ArrayField(
        models.CharField(max_length=50, blank=True, validators=[validators.validate_henkilo_oid]),
        null=True,
        blank=True,
        validators=[validators.validate_arrayfield],
    )
...
class Z6_RequestCount(AbstractModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["request_summary", "request_url_simple", "request_method", "response_code"],
...
class Z9_RelatedObjectChanged(AbstractModel):
    ...
    class Meta:
        indexes = [
            ...
            Index(
                name="varda_z9_mod_time_covering",
                fields=["model_name", "changed_timestamp"],
...
class Z11_MessageTarget(AbstractModel):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=["organisaatio", "user_type", "email"], name="organisaatio_user_type_email_unique_constraint")
        ]
