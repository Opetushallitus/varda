...
class Varhaiskasvatuspaatos(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    tuntimaara_viikossa = models.DecimalField(
        ...
        blank=False,
        null=False,
        validators=[MinValueValidator(Decimal("1.0")), MaxValueValidator(Decimal("120.0"))],
    )
...
class Maksutieto(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    palveluseteli_arvo = models.DecimalField(
        max_digits=6, decimal_places=2, default=0.00, blank=True, null=True, validators=[MinValueValidator(Decimal("0.0"))]
    )
    asiakasmaksu = models.DecimalField(
        max_digits=6, decimal_places=2, blank=False, null=False, validators=[MinValueValidator(Decimal("0.0"))]
    )
...
class Palvelussuhde(UniqueLahdejarjestelmaTunnisteMixin, HistoryAbstractModel):
    ...
    tyoaika_viikossa = models.DecimalField(
        max_digits=5, decimal_places=2, validators=[MinValueValidator(Decimal("0.0")), MaxValueValidator(Decimal("50.0"))]
    )
