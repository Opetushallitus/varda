...
from varda.custom_signal_handlers import (cas_logout_handler, celery_setup_logging_signal_handler,
                                          celery_task_failure_signal_handler, celery_task_prerun_signal_handler,
...
def handle_related_object_change(instance, history_type):
    ...
    receiver_dict = {
        ...
        VuokrattuHenkilosto.get_name(): partial(update_related_object_change, model_name=Organisaatio.get_name(),
