...
from varda.clients.oppijanumerorekisteri_client import (fetch_yhteystiedot, get_henkilo_data_by_oid,
                                                        fetch_changed_henkilot, get_huoltajuussuhde_changed_child_oids)
    ...
    for yhteystieto_ryhma in response_data.get('yhteystiedotRyhma', []):
        ...
        if yhteystieto_ryhma_tyyppi == Yhteystietoryhmatyyppi.TYOOSOITE.value:
            ...
            for yhteystieto in yhteystieto_ryhma.get('yhteystieto', []):
                ...
                if (yhteystieto_tyyppi == YhteystietoTyyppi.YHTEYSTIETO_SAHKOPOSTI.value and
                        yhteystieto_id > email_priority):
