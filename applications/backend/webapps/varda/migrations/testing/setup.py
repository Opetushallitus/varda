...
def get_random_hetu_by_age(age_years, sukupuoli_koodi):
    from varda.misc import encrypt_string, hash_string, create_hetu_from_birthday

    birth_date = datetime.now() - timedelta(days=age_years * 365)
    henkilotunnus = create_hetu_from_birthday(birth_date, sukupuoli_koodi)
    encrypted_henkilotunnus = encrypt_string(henkilotunnus)
    henkilotunnus_unique_hash = hash_string(henkilotunnus)
    return birth_date.strftime("%Y-%m-%d"), encrypted_henkilotunnus, henkilotunnus_unique_hash
...
def add_test_users():
    ...
    User.objects.create(
        username="tester", password="pbkdf2_sha256$120000$4IdDHxUJJSE6$N18zHZK02yA3KxNeTcDS4t6Ytsn2ZOLO6QLDXNT/8Yo="
    )
    User.objects.create(
        username="tester2", password="pbkdf2_sha256$120000$gNFFj5K8ZgTu$quUQQlMXZCs+1mG+nbBpTS/VXRZAy47XkR7EoioNLkQ="
    )
    User.objects.create(
        username="tester3", password="pbkdf2_sha256$150000$kfJSJbENiF5k$tZ3aa9ErAy1Ciszx40KdRMU787p7HnKHjVOQ+lzDF7U="
    )
    User.objects.create(
        username="tester4", password="pbkdf2_sha256$150000$LFrFAT6FakMM$VuLb0n11tVR0tlIBAmykLWP4an5zv4XWseGHJDlnsWk="
    )
    User.objects.create(
        username="tester5", password="pbkdf2_sha256$150000$ZX2pJZZ34sR6$XUs0RUe6IZYNdn7vYxIvm+05Ruw4brTbYG70Q3oH31s="
    )
    User.objects.create(
        username="varda-testi", password="pbkdf2_sha256$120000$0wwPCIArT7tR$OVGZGiJoJe7wqcP1CG4orfA31MUrMXlI5fHcnOUzcIw="
    )
    User.objects.create(
        username="tester-e2e", password="pbkdf2_sha256$120000$6ihvwx47epob$a2xDB6OLThL4eeEuMVw8+3QB1QBxi5hU2gZxnMwA2nE="
    )
    User.objects.create(
        username="pkvakajarjestaja1", password="pbkdf2_sha256$150000$rBZO8vnXaxun$MhKN0NOCnasVgrMsIkYfIBXaBDdRiRy8J7WQM62bARY="
    )
    User.objects.create(
        username="pkvakajarjestaja2", password="pbkdf2_sha256$150000$ptRhdza1ttgB$IJdKerCPdzhC/wDME/rUVzFTKflh2coUuaCGWomg+Lo="
    )
    User.objects.create(
        username="huoltajatietojen_tallentaja",
        password="pbkdf2_sha256$150000$S3mQ66CWYdSO$o9T08pdVyIZFqbdC8pK5cMk2O64d3xfQdw2x2vzr4M8=",
    )
    User.objects.create(
        username="vakatietojen_tallentaja",
        password="pbkdf2_sha256$150000$S3mQ66CWYdSO$o9T08pdVyIZFqbdC8pK5cMk2O64d3xfQdw2x2vzr4M8=",
    )
    User.objects.create(
        username="vakatietojen_toimipaikka_tallentaja",
        password="pbkdf2_sha256$150000$S3mQ66CWYdSO$o9T08pdVyIZFqbdC8pK5cMk2O64d3xfQdw2x2vzr4M8=",
    )
    User.objects.create(
        username="vakatietojen_toimipaikka_tallentaja_9395737548815",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="tester7", password="pbkdf2_sha256$150000$9fuSiDHlpxu4$qpRt5+aPs8Fd9VsI0XPjOvMHCN7LF+VbSJLyIghrNks="
    )
    User.objects.create(
        username="tester8", password="pbkdf2_sha256$150000$e5HLX1BadPnp$4H0r3yNEbiaTZ2yJ07HFK+8GsUM5JwKGNa/O727IOtI="
    )
    User.objects.create(
        username="tester9", password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo="
    )
    User.objects.create(
        username="tyontekija_tallentaja",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="tyontekija_katselija", password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo="
    )
    User.objects.create(
        username="tyontekija_toimipaikka_tallentaja",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="tyontekija_toimipaikka_tallentaja_9395737548815",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="tyontekija_toimipaikka_katselija",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="vuokrattu_tallentaja", password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo="
    )
    User.objects.create(
        username="tukipaatos_tallentaja",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="taydennyskoulutus_tallentaja",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="taydennyskoulutus_toimipaikka_tallentaja",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="taydennyskoulutus_toimipaikka_katselija",
        password="pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=",
    )
    User.objects.create(
        username="tester10", password="pbkdf2_sha256$150000$OULQV9qeoPsD$dH1fxZUMGFNjSM3xQzknGRJjndCUMNTj3+nyK+ET0Gc="
    )
    User.objects.create(
        username="tester11", password="pbkdf2_sha256$150000$9HnlY5WRksmT$J5TselErYqb9w2upEbgzsFwJ8tvfbU5U8y7Zj5QQJPk="
    )
    User.objects.create(
        username="tester-no-known-privileges",
        password="pbkdf2_sha256$120000$6ihvwx47epob$a2xDB6OLThL4eeEuMVw8+3QB1QBxi5hU2gZxnMwA2nE=",
    )
    User.objects.create(
        username="henkilosto_tallentaja_93957375488",
        password="pbkdf2_sha256$150000$WMst0ZmwKf3p$Fqyz4SSdybbBdAexKCjxXyqiUfYafn7XxGaxQsALqoo=",
    )
    User.objects.create(
        username="kela_luovutuspalvelu",
        password="pbkdf2_sha256$390000$sKLGfSOMYueGetSLpa2285$dsD+iLqwCfLoRszplj76FPwzFH1vlNAbWQyExBZekbM=",
    )
    User.objects.create(
        username="tilastokeskus_luovutuspalvelu",
        password="pbkdf2_sha256$390000$L5EpAc1ZKy1prUWl9vaGCx$S7TUxswyWt+0jNwb6B4I3ZWNz417n7IqJCteBkZSMSs=",
    )
    User.objects.create(
        username="avi_luovutuspalvelu",
        password="pbkdf2_sha256$390000$IgSmCp8w9XgxNLBNw0DaWz$By/jpQ9rtPjyL9UO5SddY65DXCKTFfZiCM1eoQFHwd0=",
    )
    User.objects.create(
        username="karvi_luovutuspalvelu",
        password="pbkdf2_sha256$390000$axAhybgkgB3Uh52QyQsSuB$/99rzY0e7VXwZr2Fh2Oibd7s1ePOrT5WeZY/s0XtGKM=",
    )
    User.objects.create(
        username="varda_system", password="pbkdf2_sha256$150000$WMst9QvKQ5P$Fqyz1HDLdybbBdjiKlCjxXyqiUfYafn7XxGaxQsALqoo="
    )
    User.objects.create(
        username="user_toimipaikka_9395737548810",
        password="pbkdf2_sha256$150000$WMst0ZmwKf3p$Fqyz4SSdybbBdAexKCjxXyqiUfYafn7XxGaxQsALqoo=",
    )
    User.objects.create(
        username="oph_luovutuspalvelu",
        password="pbkdf2_sha256$390000$YgYsJwbuSP665WSd8z32vS$orPN9UD5EZQVnhI/BhSgxcmHms1Ctw2YZaAkqXYfT7I=",
    )
...
def add_test_user_permissions():
    ...
    group_huoltajatiedot_tallentaja_vakajarjestaja_1 = Group.objects.get(
        name="HUOLTAJATIETO_TALLENNUS_1.2.246.562.10.34683023489"
    )
    group_huoltajatiedot_tallentaja_vakajarjestaja_2 = Group.objects.get(
        name="HUOLTAJATIETO_TALLENNUS_1.2.246.562.10.93957375488"
    )
    ...
    group_huoltajatiedot_tallentaja_toimipaikka_2935996863483 = Group.objects.get(
        name="HUOLTAJATIETO_TALLENNUS_1.2.246.562.10.2935996863483"
    )
    group_tallentaja_toimipaikka_2935996863483 = Group.objects.get(name="VARDA-TALLENTAJA_1.2.246.562.10.2935996863483")
    group_tyontekija_tallentaja_vakajarjestaja1 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_TALLENTAJA_1.2.246.562.10.34683023489"
    )
    group_tyontekija_tallentaja_vakajarjestaja2 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_TALLENTAJA_1.2.246.562.10.93957375488"
    )
    group_tyontekija_katselija_vakajarjestaja1 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_KATSELIJA_1.2.246.562.10.34683023489"
    )
    group_tyontekija_tallentaja_toimipaikka1 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_TALLENTAJA_1.2.246.562.10.9395737548810"
    )
    group_tyontekija_tallentaja_toimipaikka_9395737548815 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_TALLENTAJA_1.2.246.562.10.9395737548815"
    )
    group_tyontekija_katselija_toimipaikka1 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_KATSELIJA_1.2.246.562.10.9395737548810"
    )
    group_vuokrattu_tallentaja_vakajarjestaja1 = Group.objects.get(
        name="HENKILOSTO_VUOKRATTU_TALLENTAJA_1.2.246.562.10.34683023489"
    )
    group_tukipaatos_tallentaja_vakajarjestaja1 = Group.objects.get(name="TUEN_TIEDOT_TALLENTAJA_1.2.246.562.10.34683023489")
    group_taydennys_tallentaja_vakajarjestaja1 = Group.objects.get(
        name="HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA_1.2.246.562.10.34683023489"
    )
    group_taydennys_tallentaja_vakajarjestaja2 = Group.objects.get(
        name="HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA_1.2.246.562.10.93957375488"
    )
    group_taydennys_tallentaja_toimipaikka1 = Group.objects.get(
        name="HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA_1.2.246.562.10.9395737548810"
    )
    group_taydennys_katselija_toimipaikka1 = Group.objects.get(
        name="HENKILOSTO_TAYDENNYSKOULUTUS_KATSELIJA_1.2.246.562.10.9395737548810"
    )
    ...
    group_huoltajatiedot_tallentaja_vakajarjestaja_57294396385 = Group.objects.get(
        name="HUOLTAJATIETO_TALLENNUS_1.2.246.562.10.57294396385"
    )
    group_tyontekija_tallentaja_vakajarjestaja_57294396385 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_TALLENTAJA_1.2.246.562.10.57294396385"
    )
    group_vuokrattu_tallentaja_vakajarjestaja_57294396385 = Group.objects.get(
        name="HENKILOSTO_VUOKRATTU_TALLENTAJA_1.2.246.562.10.57294396385"
    )
    group_taydennys_tallentaja_vakajarjestaja_57294396385 = Group.objects.get(
        name="HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA_1.2.246.562.10.57294396385"
    )
    ...
    group_huoltajatiedot_tallentaja_vakajarjestaja_52966755795 = Group.objects.get(
        name="HUOLTAJATIETO_TALLENNUS_1.2.246.562.10.52966755795"
    )
    group_tyontekija_tallentaja_vakajarjestaja_52966755795 = Group.objects.get(
        name="HENKILOSTO_TYONTEKIJA_TALLENTAJA_1.2.246.562.10.52966755795"
    )
    group_vuokrattu_tallentaja_vakajarjestaja_52966755795 = Group.objects.get(
        name="HENKILOSTO_VUOKRATTU_TALLENTAJA_1.2.246.562.10.52966755795"
    )
    group_taydennys_tallentaja_vakajarjestaja_52966755795 = Group.objects.get(
        name="HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA_1.2.246.562.10.52966755795"
    )
    group_toimijatiedot_tallentaja_34683023489 = Group.objects.get(
        name="VARDA_TOIMIJATIEDOT_TALLENTAJA_1.2.246.562.10.34683023489"
    )
    group_toimijatiedot_tallentaja_57294396385 = Group.objects.get(
        name="VARDA_TOIMIJATIEDOT_TALLENTAJA_1.2.246.562.10.57294396385"
    )
    group_toimijatiedot_tallentaja_52966755795 = Group.objects.get(
        name="VARDA_TOIMIJATIEDOT_TALLENTAJA_1.2.246.562.10.52966755795"
    )
    ...
    group_oph_luovutuspalvelu = Group.objects.get(name="VARDA_LUOVUTUSPALVELU_1.2.246.562.10.00000000001")
    ...
    vakatietojen_toimipaikka_tallentaja_9395737548815 = User.objects.get(
        username="vakatietojen_toimipaikka_tallentaja_9395737548815"
    )
    ...
    vuokrattu_tallentaja = User.objects.get(username="vuokrattu_tallentaja")
    vuokrattu_tallentaja.groups.add(group_vuokrattu_tallentaja_vakajarjestaja1)

    tukipaatos_tallentaja = User.objects.get(username="tukipaatos_tallentaja")
    tukipaatos_tallentaja.groups.add(group_tukipaatos_tallentaja_vakajarjestaja1)
    ...
    user_tester10.groups.add(group_vuokrattu_tallentaja_vakajarjestaja_57294396385)
    ...
    user_tester11.groups.add(group_vuokrattu_tallentaja_vakajarjestaja_52966755795)
    ...
    oph_luovutuspalvelu = User.objects.get(username="oph_luovutuspalvelu")
    oph_luovutuspalvelu.groups.add(group_oph_luovutuspalvelu)
...
def create_vakajarjestajat():
    ...
    organisaatio_list = (
        ...
        Organisaatio.objects.create(
            ...
            client_cert_common_name="varda.kela.fi",
        ),
        Organisaatio.objects.create(
            nimi="Opetushallitus",
            y_tunnus="",
...
def create_toimipaikat_and_painotukset():
    ...
    kielipainotus_list = (
        ...
        },
        {
            ...
            "kielipainotustyyppi_koodi": "KI02",
        ...
        },
        {
            ...
            "kielipainotustyyppi_koodi": "KI03",
...
def create_henkilot():
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=7.2, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=6.1, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=6.25, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=4.15, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    # 010280-952L Huoltaja jolla lapsi 1.2.246.562.24.86012997950
    Henkilo.objects.create(
    ...
    # huoltajan (010280-952L) lapsi
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=5.5, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=6.3, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=5.3, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=5.7, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=5.1, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=5.35, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=5.0, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=4.3, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=3.3, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(age_years=42.0, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
        henkilo_oid="1.2.246.562.24.47279949999",
        etunimet="Tuomo",
        kutsumanimi="Tuomo",
        sukunimi="Tutkinto",
        aidinkieli_koodi="FI",
...
def _create_lapsi_and_related_data(lapsi, huoltaja_list=(), vakapaatos_list=(), maksutieto_list=()):
    ...
    for huoltaja_identifier in huoltaja_list:
        huoltaja_filter = (
            Q(henkilotunnus_unique_hash=hash_string(huoltaja_identifier))
        ...
        Huoltajuussuhde.objects.get_or_create(huoltaja=huoltaja_obj, lapsi_id=lapsi_id, defaults={"voimassa_kytkin": True})
...
def create_lapset():
    ...
    _create_lapsi_and_related_data(
        ...
        maksutieto_list=(
            {
                "huoltajat": [{"henkilo_oid": "1.2.246.562.24.7777777777788", "etunimet": "Mari", "sukunimi": "Mairinen"}],
                "maksun_peruste_koodi": "mp03",
                "palveluseteli_arvo": 100,
                "asiakasmaksu": 150,
                "perheen_koko": 2,
    ...
    _create_lapsi_and_related_data(
        ...
        maksutieto_list=(
            {
                "huoltajat": [{"henkilo_oid": "1.2.246.562.24.99924839517", "etunimet": "Tessa", "sukunimi": "Testilä"}],
                "maksun_peruste_koodi": "mp03",
                "palveluseteli_arvo": 0.00,
                "asiakasmaksu": 150,
    ...
    _create_lapsi_and_related_data(
        ...
        maksutieto_list=(
            {
                "huoltajat": [{"henkilo_oid": "1.2.246.562.24.44825558743", "etunimet": "Maija", "sukunimi": "Mallikas"}],
                "maksun_peruste_koodi": "mp03",
                "palveluseteli_arvo": 0.00,
                "asiakasmaksu": 150,
                "alkamis_pvm": "2020-05-20",
    ...
    _create_lapsi_and_related_data(
        ...
        huoltaja_list=(
            "1.2.246.562.24.2434693467574",
            "1.2.246.562.24.3367432256266",
        ),
        vakapaatos_list=(
            (
                {
    ...
    kela_testing_vakasuhteet = Varhaiskasvatussuhde.objects.filter(
        tunniste__in=(
            "kela_testing_jm03",
            "testing-varhaiskasvatussuhde4",
...
def create_koodisto(name, name_koodistopalvelu, codes):
    ...
    try:
        koodisto_obj = Z2_Koodisto.objects.create(
            name=name, name_koodistopalvelu=name_koodistopalvelu, update_datetime=update_datetime, version=1
        )
        for code in codes:
            code_obj = Z2_Code.objects.create(koodisto=koodisto_obj, code_value=code)
            for lang in SupportedLanguage.list():
                Z2_CodeTranslation.objects.create(code=code_obj, language=lang, name="test nimi", description="test kuvaus")
    except IntegrityError:
        logger.warning(f"Error creating koodisto {name}")


def create_initial_koodisto_data():
    from varda import koodistopalvelu, lokalisointipalvelu
    ...
    koodisto_codes = {
        ...
        "toiminnallinen_painotus_koodit": [
            "tp01",
            "tp02",
            "tp03",
            "tp04",
        ...
        "lokalisointi_virkailija": Translation.list(),
        "kielipainotustyyppi_koodit": ["KI01", "KI02", "KI03"],
        "ikaryhma_koodit": ["IR01", "IR02", "IR03", "IR04", "IR05"],
        "tuentaso_koodit": ["TT01", "TT02", "TT03"],
    }

    for key, value in (koodistopalvelu.KOODISTOPALVELU_DICT | lokalisointipalvelu.LOKALISOINTIPALVELU_DICT).items():
    ...
    update_localization_translations()
    ...
    for code_translation in (
        ...
        (
            Z2_CodeTranslation.objects.filter(
                code__code_value=code_translation[0], code__koodisto__name=Koodistot.yritysmuoto_koodit.value, language="FI"
            ).update(name=code_translation[1])
        )


def update_localization_translations():
    from varda.enums.lokalisointi import Lokalisointi
    from varda.enums.translation import Translation
    from varda.models import Z2_CodeTranslation

    # Update certain localization translations which must have certain number of replacement placeholders
    translation_query = Z2_CodeTranslation.objects.filter(code__koodisto__name=Lokalisointi.VIRKAILIJA.value)
    translation_query.filter(code__code_value=Translation.EMAIL_NO_PAAKAYTTAJA_MESSAGE.value).update(name="{}")
    translation_query.filter(code__code_value=Translation.EMAIL_PUUTTEELLISET_MESSAGE.value).update(name="{}{}")
    (
        translation_query.filter(code__code_value=Translation.EMAIL_PUUTTEELLISET_MESSAGE_ERROR_TEMPLATE.value).update(
            name="{}{}{}"
        )
    )
    translation_query.filter(code__code_value=Translation.EMAIL_NO_TRANSFERS_MESSAGE_KUNTA.value).update(name="{}{}{}")
    (translation_query.filter(code__code_value=Translation.EMAIL_NO_TRANSFERS_MESSAGE_YKSITYINEN.value).update(name="{}{}{}"))
    translation_query.filter(code__code_value=Translation.EMAIL_COULD_NOT_DELIVER_MESSAGE.value).update(name="{}{}{}")


def get_vakajarjestaja_oids(create_all_vakajarjestajat):
    vakajarjestaja_oids = ["1.2.246.562.10.27580498759"]  # Parikkalan kunta
...
def create_or_update_henkilo(henkilo_defaults, henkilo_hetu, henkilo_hetu_hash, henkilo_oid):
    ...
    if henkilo_query := Henkilo.objects.filter(henkilotunnus_unique_hash=henkilo_hetu_hash):
        ...
        henkilo = Henkilo.objects.create(
            **henkilo_defaults, henkilotunnus=henkilo_hetu, henkilotunnus_unique_hash=henkilo_hetu_hash, henkilo_oid=henkilo_oid
        )
...
def create_onr_lapsi_huoltajat(create_all_vakajarjestajat=False):
    ...
    henkilo_1_created, henkilo_1 = create_or_update_henkilo(
        henkilo_1_defaults, henkilo_1_hetu, henkilo_1_hetu_hash, henkilo_1_oid
    )
    ...
    henkilo_2_created, henkilo_2 = create_or_update_henkilo(
        henkilo_2_defaults, henkilo_2_hetu, henkilo_2_hetu_hash, henkilo_2_oid
    )
    ...
    henkilo_3_created, henkilo_3 = create_or_update_henkilo(
        henkilo_3_defaults, henkilo_3_hetu, henkilo_3_hetu_hash, henkilo_3_oid
    )
    ...
    henkilo_4_created, henkilo_4 = create_or_update_henkilo(
        henkilo_4_defaults, henkilo_4_hetu, henkilo_4_hetu_hash, henkilo_4_oid
    )
    ...
    for organisaatio_oid in vakajarjestaja_oids:
        ...
        vakajarjestaja_permission_groups = [
            group_tallentaja,
            group_katselija,
            group_paakayttaja,
            group_huoltajatiedot_tallentaja,
            group_huoltajatiedot_katselija,
        ]
...
def create_henkilosto():
    import datetime
    from varda.models import VuokrattuHenkilosto
    ...
    vuokrattu_henkilosto_list = (
        ...
        },
        {
            ...
            "tyontekijamaara": 5,
            "lahdejarjestelma": "1",
            "tunniste": "testing-vuokrattuhenkilosto2",
        },
        {
            "vakajarjestaja_oid": "1.2.246.562.10.52966755795",
            "kuukausi": "2020-10-01",
            ...
            "tyontekijamaara": 5,
            "lahdejarjestelma": "1",
            "tunniste": "testing-vuokrattuhenkilosto3",
        },
    )
    # Because VuokrattuHenkilosto can be saved for current or previous period, we need to save with temporary date and
    # then update the intended date
    date_iterator_init = datetime.date.today()
    date_iterator_init = date_iterator_init.replace(day=1)
    date_iterator_dict = {}
    for vuokrattu_henkilosto in vuokrattu_henkilosto_list:
        vakajarjestaja_oid = vuokrattu_henkilosto["vakajarjestaja_oid"]
        date_iterator = date_iterator_dict.get(vakajarjestaja_oid, None)
        if not date_iterator:
            date_iterator = date_iterator_init

        original_date = vuokrattu_henkilosto["kuukausi"]
        vuokrattu_henkilosto["kuukausi"] = date_iterator.strftime("%Y-%m-%d")
        resp = _make_post_request("/api/henkilosto/v1/tilapainen-henkilosto/", vuokrattu_henkilosto)
        vuokrattu_henkilosto_obj = VuokrattuHenkilosto.objects.get(id=json.loads(resp.content)["id"])
        vuokrattu_henkilosto_obj.kuukausi = original_date
        vuokrattu_henkilosto_obj.save()
    ...
    taydennyskoulutus_list = (
        ...
        },
        {
            ...
            "koulutuspaivia": "1.5",
            "lahdejarjestelma": "1",
            "tunniste": "testing-taydennyskoulutus1_2",
        },
        {
            "taydennyskoulutus_tyontekijat": [
...
def create_login_certs():
    ...
    for url in [
        "/api/reporting/v2/kela/etuusmaksatus/aloittaneet/",
        "/api/reporting/v2/kela/etuusmaksatus/lopettaneet/",
        "/api/reporting/v2/kela/etuusmaksatus/maaraaikaiset/",
        "/api/reporting/v2/kela/etuusmaksatus/korjaustiedot/",
        "/api/reporting/v2/kela/etuusmaksatus/korjaustiedotpoistetut/",
    ]:
        LoginCertificate.objects.update_or_create(
            organisaatio=organisaatio_kela, common_name="kela cert", user=user_kela, api_path=url
        )
    ...
    for url in [
        ...
        LoginCertificate.objects.update_or_create(
            organisaatio=organisaatio_tilastokeskus, common_name="stat.fi", user=user_tilastokeskus, api_path=url
        )
    ...
    LoginCertificate.objects.update_or_create(
        organisaatio=organisaatio_avi, common_name="avi.fi", user=user_avi, api_path="/api/reporting/v1/avi/"
    )
    ...
    for url in ["/api/reporting/v1/valssi/organisaatiot/", "/api/reporting/v1/valssi/toimipaikat/"]:
        LoginCertificate.objects.update_or_create(
            organisaatio=organisaatio_karvi, common_name="karvi.fi", user=user_karvi, api_path=url
        )

    user_oph = User.objects.get(username="oph_luovutuspalvelu")
    organisaatio_oph = Organisaatio.objects.get(organisaatio_oid="1.2.246.562.10.00000000001")
    LoginCertificate.objects.update_or_create(
        organisaatio=organisaatio_oph, common_name="oph.fi", user=user_oph, api_path="/api/reporting/v1/vipunen/"
    )
...
def get_onr_huoltaja_hetut() -> list[str]:
    """
    Huoltajat from Lapsi+huoltaja -pairs in ONR
    https://jira.eduuni.fi/browse/OPHVARDA-2805
    """
    return [
        "010180-953U",
        "280735-985H",
...
def get_onr_lapset() -> list[OnrHenkilo]:
    """
    Lapset from Lapsi+huoltaja -pairs in ONR
    https://jira.eduuni.fi/browse/OPHVARDA-2805
    """
    return [
        {"henkilotunnus": "010215A951T", "sukunimi": "Kotilainen-Testi", "etunimet": "Ahto Testi", "kutsumanimi": "Ahto"},
        {
            "henkilotunnus": "011118A908E",
            "sukunimi": "Kainulainen-Testi",
            "etunimet": "Anna-Kaisa Testi",
            "kutsumanimi": "Anna-Kaisa",
        },
        {"henkilotunnus": "110409A956F", "sukunimi": "Pyykönen-Testi", "etunimet": "Meeri Testi", "kutsumanimi": "Meeri"},
        {"henkilotunnus": "240216A995A", "sukunimi": "Siren-Testi", "etunimet": "Mikael Testi", "kutsumanimi": "Mikael"},
        {"henkilotunnus": "060510A904M", "sukunimi": "Martikainen-Testi", "etunimet": "Jenni Testi", "kutsumanimi": "Jenni"},
        {
            "henkilotunnus": "150614A9647",
            "sukunimi": "Kaipainen-Testi",
            "etunimet": "Alexandra Testi",
            "kutsumanimi": "Alexandra",
        },
        {"henkilotunnus": "160514A9066", "sukunimi": "Karvonen-Testi", "etunimet": "Saima Testi", "kutsumanimi": "Saima"},
        {"henkilotunnus": "231108A932U", "sukunimi": "Lindell-Testi", "etunimet": "Josefiina Testi", "kutsumanimi": "Josefiina"},
        {"henkilotunnus": "121211A945R", "sukunimi": "Hovi-Testi", "etunimet": "Erkka Testi", "kutsumanimi": "Erkka"},
        {"henkilotunnus": "240819A959S", "sukunimi": "Kopra-Testi", "etunimet": "Alvar Testi", "kutsumanimi": "Alvar"},
        {"henkilotunnus": "090219A973P", "sukunimi": "Sjöblom-Testi", "etunimet": "Mitja Testi", "kutsumanimi": "Mitja"},
        {"henkilotunnus": "100621A067V", "sukunimi": "Forsman", "etunimet": "Eino", "kutsumanimi": "Eino"},
        {"henkilotunnus": "100318A616C", "sukunimi": "Kirkanen", "etunimet": "Nina", "kutsumanimi": "Nina"},
        {"henkilotunnus": "280917A024F", "sukunimi": "Bärlund", "etunimet": "Kirsi Maria", "kutsumanimi": "Kirsi"},
        {"henkilotunnus": "290419A031U", "sukunimi": "Saarela", "etunimet": "Elina Kristiina", "kutsumanimi": "Elina"},
        {"henkilotunnus": "180918A2419", "sukunimi": "Alho", "etunimet": "Minna Kristiina", "kutsumanimi": "Minna"},
    ]
