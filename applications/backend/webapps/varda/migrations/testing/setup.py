...
def add_test_users():
    ...
    User.objects.create(username='vuokrattu_tallentaja', password='pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=')
    User.objects.create(username='tukipaatos_tallentaja', password='pbkdf2_sha256$150000$ntAfCrXVuXnI$A63mBzAb7EzHDdR6jTSGZDmmYj0OtfbgetIFbtBZXBo=')
    ...
    User.objects.create(username='oph_luovutuspalvelu', password='pbkdf2_sha256$390000$YgYsJwbuSP665WSd8z32vS$orPN9UD5EZQVnhI/BhSgxcmHms1Ctw2YZaAkqXYfT7I=')
...
def add_test_user_permissions():
    ...
    group_vuokrattu_tallentaja_vakajarjestaja1 = Group.objects.get(name='HENKILOSTO_VUOKRATTU_TALLENTAJA_1.2.246.562.10.34683023489')
    ...
    group_vuokrattu_tallentaja_vakajarjestaja_57294396385 = Group.objects.get(name='HENKILOSTO_VUOKRATTU_TALLENTAJA_1.2.246.562.10.57294396385')
    ...
    group_vuokrattu_tallentaja_vakajarjestaja_52966755795 = Group.objects.get(name='HENKILOSTO_VUOKRATTU_TALLENTAJA_1.2.246.562.10.52966755795')
...
def create_henkilot():
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=7.2, sukupuoli_koodi=1)
    Henkilo.objects.create(
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=6.1, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=6.25, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=4.15, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=5.5, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=6.3, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=5.3, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=5.7, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=5.1, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=5.35, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=5.0, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=4.3, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=3.3, sukupuoli_koodi=2)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
    ...
    birth_date, enc_hetu, hetu_uniq_hash = get_random_hetu_by_age(
        age_years=42.0, sukupuoli_koodi=1)
    Henkilo.objects.create(
        henkilotunnus=enc_hetu,
        henkilotunnus_unique_hash=hetu_uniq_hash,
        syntyma_pvm=birth_date,
...
def create_lapset():
    ...
    _create_lapsi_and_related_data(
        ...
        maksutieto_list=(
            {
                'huoltajat': [
                    {'henkilo_oid': '1.2.246.562.24.99924839517', 'etunimet': 'Tessa', 'sukunimi': 'Testilä'}
                ],
                'maksun_peruste_koodi': 'mp03',
                'palveluseteli_arvo': 0.00,
                'asiakasmaksu': 150,
...
def update_localization_translations():
    ...
    (translation_query
     .filter(code__code_value=Translation.EMAIL_PUUTTEELLISET_MESSAGE_ERROR_TEMPLATE.value)
     .update(name='{}{}{}'))
    translation_query.filter(code__code_value=Translation.EMAIL_NO_TRANSFERS_MESSAGE_KUNTA.value).update(name='{}{}{}')
    (translation_query
     .filter(code__code_value=Translation.EMAIL_NO_TRANSFERS_MESSAGE_YKSITYINEN.value)
     .update(name='{}{}{}'))
...
def create_login_certs():
    ...
    for url in ['/api/reporting/v2/kela/etuusmaksatus/aloittaneet/',
    ...
    LoginCertificate.objects.update_or_create(organisaatio=organisaatio_oph, common_name='oph.fi', user=user_oph,
                                              api_path='/api/reporting/v1/vipunen/')
...
def get_onr_lapset() -> list[OnrHenkilo]:
    ...
    return [
        ...
        {
            'henkilotunnus': '110409A956F',
            'sukunimi': 'Pyykönen-Testi',
            'etunimet': 'Meeri Testi',
            'kutsumanimi': 'Meeri'
        },
        {
            'henkilotunnus': '240216A995A',
            'sukunimi': 'Siren-Testi',
            'etunimet': 'Mikael Testi',
            'kutsumanimi': 'Mikael'
        },
        {
            'henkilotunnus': '060510A904M',
            'sukunimi': 'Martikainen-Testi',
            'etunimet': 'Jenni Testi',
            'kutsumanimi': 'Jenni'
        },
        {
        ...
        {
            'henkilotunnus': '160514A9066',
            'sukunimi': 'Karvonen-Testi',
            'etunimet': 'Saima Testi',
            'kutsumanimi': 'Saima'
        },
        {
            'henkilotunnus': '231108A932U',
            'sukunimi': 'Lindell-Testi',
            'etunimet': 'Josefiina Testi',
            'kutsumanimi': 'Josefiina'
        },
        {
            'henkilotunnus': '121211A945R',
            'sukunimi': 'Hovi-Testi',
            'etunimet': 'Erkka Testi',
            'kutsumanimi': 'Erkka'
        },
        {
            'henkilotunnus': '240819A959S',
            'sukunimi': 'Kopra-Testi',
            'etunimet': 'Alvar Testi',
            'kutsumanimi': 'Alvar'
        },
        {
            'henkilotunnus': '090219A973P',
            'sukunimi': 'Sjöblom-Testi',
            'etunimet': 'Mitja Testi',
            'kutsumanimi': 'Mitja'
        },
        {
            'henkilotunnus': '100621A067V',
            'sukunimi': 'Forsman',
            'etunimet': 'Eino',
            'kutsumanimi': 'Eino'
        },
        {
            'henkilotunnus': '100318A616C',
            'sukunimi': 'Kirkanen',
            'etunimet': 'Nina',
            'kutsumanimi': 'Nina'
        },
        {
            'henkilotunnus': '280917A024F',
            'sukunimi': 'Bärlund',
            'etunimet': 'Kirsi Maria',
            'kutsumanimi': 'Kirsi'
        },
        {
            'henkilotunnus': '290419A031U',
            'sukunimi': 'Saarela',
            'etunimet': 'Elina Kristiina',
            'kutsumanimi': 'Elina'
        },
        {
            'henkilotunnus': '180918A2419',
            'sukunimi': 'Alho',
            'etunimet': 'Minna Kristiina',
            'kutsumanimi': 'Minna'
        }
    ]
