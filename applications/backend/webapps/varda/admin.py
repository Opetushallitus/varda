...
from .models import (Aikaleima, BatchError, Henkilo, Huoltaja, Huoltajuussuhde, KieliPainotus, Lapsi, LoginCertificate,
                     ...
                     Palvelussuhde, PaosOikeus, PaosToiminta, VuokrattuHenkilosto, ToiminnallinenPainotus, Toimipaikka,
                     Tutkinto, Tyontekija, Organisaatio, Varhaiskasvatuspaatos, Varhaiskasvatussuhde, PidempiPoissaolo,
                     Taydennyskoulutus, Z3_AdditionalCasUserFields, Z7_AdditionalUserFields, TukipaatosAikavali,
                     Tukipaatos)
...
class AikaleimaAdmin(AdminWithGuardianAndHistory):
    list_display = ('avain', 'organisaatio',)
    search_fields = ('avain', '=organisaatio__id',)
...
class TukipaatosAdmin(AdminWithGuardianAndHistory):
    list_display = ('id', 'vakajarjestaja', 'paatosmaara', 'yksityinen_jarjestaja', 'ikaryhma_koodi', 'tuentaso_koodi',
                    'tilastointi_pvm',)
    search_fields = ('=id', '=vakajarjestaja__id', 'paatosmaara', 'ikaryhma_koodi', 'tuentaso_koodi', 'tilastointi_pvm',)
    raw_id_fields = ('vakajarjestaja',)
