...
class LapsiAdmin(AdminWithGuardianAndHistory):
    list_display = (
        ...
        "get_henkilo_oid",
        "get_vakatoimija_oid",
        "get_oma_organisaatio_oid",
        "get_paos_organisaatio_oid",
    )
    search_fields = (
        "=id",
        "=vakatoimija__organisaatio_oid",
...
class PaosOikeusAdmin(AdminWithGuardianAndHistory):
    list_display = (
        "id",
        "get_jarjestaja_kunta_organisaatio_oid",
        "get_tuottaja_organisaatio_oid",
    )
    search_fields = (
        "=id",
        "=jarjestaja_kunta_organisaatio__organisaatio_oid",
        "=tuottaja_organisaatio__organisaatio_oid",
    )
    raw_id_fields = (
        "jarjestaja_kunta_organisaatio",
        "tuottaja_organisaatio",
        "tallentaja_organisaatio",
    )

    @display(
        ordering="jarjestaja_kunta_organisaatio__organisaatio_oid", description="jarjestaja_kunta_organisaatio organisaatio_oid"
    )
...
class TyoskentelypaikkaAdmin(AdminWithGuardianAndHistory):
    list_display = (
        "id",
        "palvelussuhde",
        "get_toimipaikka_organisaatio_oid",
    )
    search_fields = (
        "=id",
        "=palvelussuhde__id",
        "=toimipaikka__organisaatio_oid",
    )
    raw_id_fields = (
        "palvelussuhde",
        "toimipaikka",
...
class VuokrattuHenkilostoAdmin(AdminWithGuardianAndHistory):
    list_display = (
        "id",
        "get_vakajarjestaja_oid",
    )
...
class AikaleimaAdmin(AdminWithGuardianAndHistory):
    list_display = (
        "avain",
        "organisaatio",
    )
...
class LoginCertificateAdmin(AdminWithGuardianAndHistory):
    list_display = (
        "id",
        "get_organisaatio_oid",
        "api_path",
    )
    search_fields = (
        "=id",
        "=organisaatio__organisaatio_oid",
        "api_path",
    )
    raw_id_fields = (
        "user",
...
class TukipaatosAdmin(AdminWithGuardianAndHistory):
    list_display = (
        "id",
        "vakajarjestaja",
        "paatosmaara",
...
class TukipaatosAikavaliAdmin(AdminWithGuardianAndHistory):
    change_form_template = "admin/tuen_change_form.html"
    fields = ["alkamis_pvm", "paattymis_pvm", "tilastointi_pvm"]
...
admin.site.register(VuokrattuHenkilosto, VuokrattuHenkilostoAdmin)
...
admin.site.register(Aikaleima, AikaleimaAdmin)
...
admin.site.register(Tukipaatos, TukipaatosAdmin)
admin.site.register(TukipaatosAikavali, TukipaatosAikavaliAdmin)
