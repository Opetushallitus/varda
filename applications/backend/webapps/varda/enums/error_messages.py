...
class ErrorMessages(enum.Enum):
    ...
    MA021 = get_error_dict('MA021', 'Maksutieto palveluseteli_arvo is 0 for lapsi with varhaiskasvatuspäätös järjestämismuoto set to palveluseteli.')
    ...
    TK017 = get_error_dict('TK017', 'The combination of nimi, suoritus_pvm, and koulutuspaivia must be unique for each Tyontekija.')
    ...
    TT004 = get_error_dict('TT004', 'The combination of vakajarjestaja_oid, yksityinen_jarjestaja, ikaryhma_koodi, tilastointi_pvm, tuentaso_koodi must be unique.')
    ...
    MI022 = get_error_dict('MI022', "Postinumero is invalid. Starts with '000' not allowed and have to end with '0'. '00099' is allowed.")
