...
from varda.models import (Huoltaja, Lapsi, Maksutieto, Organisaatio, PidempiPoissaolo, Taydennyskoulutus,
                          TaydennyskoulutusTyontekija, VuokrattuHenkilosto, Toimipaikka, Tyontekija, Tyoskentelypaikka,
...
class PulssiViewSet(GenericViewSet, ListModelMixin):
    ...
    def get_data(self):
        ...
        toimipaikka_by_ak = {row['toimintakieli_lower']: row['count'] for row in
                             Toimipaikka.objects
                             .filter(active_filter)
        ...
        vuokrattu_henkilosto_aggregate = (VuokrattuHenkilosto.objects
