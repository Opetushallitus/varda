...
class HaeYksiloimattomatHenkilotViewSet(GenericViewSet, ListModelMixin):
    ...
    def get_queryset(self):
        return self.queryset.order_by("lapsi__vakatoimija__organisaatio_oid", "tyontekijat__vakajarjestaja__organisaatio_oid")
...
class NestedLapsiViewSet(GenericViewSet, ListModelMixin):
    ...
    def list(self, request, *args, **kwargs):
        ...
        queryset = self.filter_queryset(Lapsi.objects.filter(huoltajuussuhteet__huoltaja__id=kwargs["huoltaja_pk"])).order_by(
            "id"
        )
