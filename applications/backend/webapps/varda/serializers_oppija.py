...
class OppijaTaydennyskoulutusSerializer(serializers.ModelSerializer):
    ...
    koulutuspaivia = serializers.DecimalField(
        read_only=True, max_digits=4, decimal_places=1, source="taydennyskoulutus__koulutuspaivia"
    )
...
class OppijaTyontekijaSerializer(AbstractAktiivinenToimijaYhteystietoSerializer):
    ...
    def get_taydennyskoulutukset(self, tyontekija):
        ...
        qs = qs.values(
            ...
            "taydennyskoulutus__nimi",
            "taydennyskoulutus__suoritus_pvm",
            "taydennyskoulutus__koulutuspaivia",
...
class HuoltajatiedotSerializer(serializers.ModelSerializer):
    ...
    huoltajuussuhteet = OppijaHuoltajuussuhdeSerializer(source="huoltaja.huoltajuussuhteet", many=True, read_only=True)
