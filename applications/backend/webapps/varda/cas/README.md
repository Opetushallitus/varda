...
CAS-oppija is used for citizen authentication without e-authorization (valtuudet).
...
2. User is redirected back to Varda
3. User's `Z3_AdditionalCasUserFields.huollettava_oid_list` is updated if needed
