...
def validate_postinumero_toimipaikka(postinumero):
    """
    Validate the postal code: numeric, length 5 string
    Cannot start with '000'. Have to end with '0'. '00099' is allowed.
    """
    validate_postinumero(postinumero)
    if postinumero == '00099':
        pass
    elif not postinumero.startswith('000') and postinumero.endswith('0'):
        pass
    else:
...
def validate_kielipainotustyyppi_koodi(kielipainotustyyppi_koodi, alkamis_pvm=None, paattymis_pvm=None,
                                       field_name='kielipainotustyyppi_koodi'):
    validate_z2_koodi(kielipainotustyyppi_koodi, Koodistot.kielipainotustyyppi_koodit.value, alkamis_pvm, paattymis_pvm,
                      field_name)


def validate_tuentaso_koodi(tuentaso_koodi, alkamis_pvm=None, paattymis_pvm=None,
                            field_name='tuentaso_koodi'):
    validate_z2_koodi(tuentaso_koodi, Koodistot.tuentaso_koodit.value, alkamis_pvm, paattymis_pvm,
                      field_name)


def validate_ikaryhma_koodi(ikaryhma_koodi, alkamis_pvm=None, paattymis_pvm=None,
                            field_name='ikaryhma_koodi'):
    validate_z2_koodi(ikaryhma_koodi, Koodistot.ikaryhma_koodit.value, alkamis_pvm, paattymis_pvm,
                      field_name)
