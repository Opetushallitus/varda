...
from varda.misc import (
    decrypt_henkilotunnus, TemporaryObject, decrypt_excel_report_password, get_latest_tilastointi_pvm_before_date,
    get_tuen_tiedot_tuen_taso_paatosmaaras,
)
from varda.misc_queries import (
    get_active_filter, get_koodisto_codes_lower, get_yearly_report_kielipainotus_count,
    get_yearly_report_lapsi_ids, get_yearly_report_maksutieto_data,
    get_yearly_report_organisaatio_count, get_yearly_report_palvelussuhde_data,
    get_yearly_report_taydennyskoulutus_data, get_yearly_report_tyontekija_ids,
...
from varda.models import (
    Varhaiskasvatussuhde, Z8_ExcelReport, Maksutieto, Z2_Code, Z8_ExcelReportLog, Lapsi, Tyontekija, Toimipaikka,
    Palvelussuhde, TaydennyskoulutusTyontekija)
...
TRANSLATIONS = {
    VAKASUHDE_HEADERS_CUSTOM: (T.EXCEL_OPPIJANUMERO, T.EXCEL_HETU,),
    VAKASUHDE_HEADERS: (T.EXCEL_OPPIJANUMERO, T.EXCEL_ETUNIMET, T.EXCEL_SUKUNIMI, T.EXCEL_HETU, T.EXCEL_TURVAKIELTO,
                        T.EXCEL_LAPSI_ID, T.EXCEL_PAOS_KYTKIN, T.EXCEL_PAOS_NIMI, T.EXCEL_PAOS_OID,
                        T.EXCEL_LAHDEJARJESTELMA, T.EXCEL_VARHAISKASVATUSPAATOS_ID, T.EXCEL_HAKEMUS_PVM,
                        T.EXCEL_ALKAMIS_PVM, T.EXCEL_PAATTYMIS_PVM, T.EXCEL_JARJESTAMISMUOTO,
                        T.EXCEL_PAIVITTAINEN_KYTKIN, T.EXCEL_KOKOPAIVAINEN_KYTKIN, T.EXCEL_VUOROHOITO_KYTKIN,
                        T.EXCEL_TUNTIMAARA_VIIKOSSA, T.EXCEL_TILAPAINEN_KYTKIN, T.EXCEL_VARHAISKASVATUSSUHDE_ID,
                        T.EXCEL_ALKAMIS_PVM, T.EXCEL_PAATTYMIS_PVM, T.EXCEL_TOIMIPAIKKA_NIMI, T.EXCEL_TOIMIPAIKKA_OID,
                        T.EXCEL_TOIMIPAIKKA_ID,),
    MAKSUTIETO_HEADERS: (T.EXCEL_OPPIJANUMERO, T.EXCEL_ETUNIMET, T.EXCEL_SUKUNIMI, T.EXCEL_HETU, T.EXCEL_TURVAKIELTO,
                         T.EXCEL_LAPSI_ID, T.EXCEL_PAOS_KYTKIN, T.EXCEL_PAOS_NIMI, T.EXCEL_PAOS_OID,
                         T.EXCEL_MAKSUTIETO_ID, T.EXCEL_ALKAMIS_PVM, T.EXCEL_PAATTYMIS_PVM, T.EXCEL_PERHEEN_KOKO,
                         T.EXCEL_MAKSUN_PERUSTE, T.EXCEL_ASIAKASMAKSU, T.EXCEL_PALVELUSETELI_ARVO,
                         T.EXCEL_HUOLTAJA_OPPIJANUMERO, T.EXCEL_HUOLTAJA_ETUNIMET, T.EXCEL_HUOLTAJA_SUKUNIMI,),
    PUUTTEELLISET_TOIMIPAIKKA_HEADERS: (T.EXCEL_TOIMIPAIKKA_NIMI, T.EXCEL_TOIMIPAIKKA_OID, T.EXCEL_TOIMIPAIKKA_ID,
                                        T.EXCEL_LAHDEJARJESTELMA, T.EXCEL_ERROR, T.EXCEL_TIETOSISALTO,
                                        T.EXCEL_OBJECT_ID, T.EXCEL_VOIMASSAOLO,),
    PUUTTEELLISET_LAPSI_HEADERS: (T.EXCEL_OPPIJANUMERO, T.EXCEL_ETUNIMET, T.EXCEL_SUKUNIMI, T.EXCEL_HETU,
                                  T.EXCEL_TURVAKIELTO, T.EXCEL_LAPSI_ID, T.EXCEL_PAOS_KYTKIN, T.EXCEL_PAOS_NIMI,
                                  T.EXCEL_PAOS_OID, T.EXCEL_LAHDEJARJESTELMA, T.EXCEL_ERROR, T.EXCEL_TIETOSISALTO,
                                  T.EXCEL_OBJECT_ID, T.EXCEL_VOIMASSAOLO,),
    PUUTTEELLISET_TYONTEKIJA_HEADERS: (T.EXCEL_OPPIJANUMERO, T.EXCEL_ETUNIMET, T.EXCEL_SUKUNIMI, T.EXCEL_HETU,
                                       T.EXCEL_TURVAKIELTO, T.EXCEL_TYONTEKIJA_ID, T.EXCEL_LAHDEJARJESTELMA,
                                       T.EXCEL_ERROR, T.EXCEL_TIETOSISALTO, T.EXCEL_OBJECT_ID, T.EXCEL_VOIMASSAOLO,),
    TYONTEKIJA_HEADERS: (T.EXCEL_OPPIJANUMERO, T.EXCEL_ETUNIMET, T.EXCEL_SUKUNIMI, T.EXCEL_HETU, T.EXCEL_EMAIL,
                         T.EXCEL_TURVAKIELTO, T.EXCEL_TYONTEKIJA_ID, T.EXCEL_LAHDEJARJESTELMA, T.EXCEL_PALVELUSSUHDE_ID,
                         T.EXCEL_PALVELUSSUHDE_TUNNISTE, T.EXCEL_PALVELUSSUHDE_TYYPPI, T.EXCEL_TYOAIKA,
                         T.EXCEL_TUTKINTO, T.EXCEL_TYOAIKA_VIIKOSSA, T.EXCEL_ALKAMIS_PVM, T.EXCEL_PAATTYMIS_PVM,
                         T.EXCEL_TYOSKENTELYPAIKKA_ID, T.EXCEL_TYOSKENTELYPAIKKA_TUNNISTE, T.EXCEL_KIERTAVA_KYTKIN,
                         T.EXCEL_TOIMIPAIKKA_NIMI, T.EXCEL_TOIMIPAIKKA_OID, T.EXCEL_TOIMIPAIKKA_ID,
                         T.EXCEL_TEHTAVANIMIKE, T.EXCEL_KELPOISUUS_KYTKIN, T.EXCEL_ALKAMIS_PVM, T.EXCEL_PAATTYMIS_PVM,
                         T.EXCEL_PIDEMPI_POISSAOLO_ID, T.EXCEL_PIDEMPI_POISSAOLO_TUNNISTE, T.EXCEL_ALKAMIS_PVM,
                         T.EXCEL_PAATTYMIS_PVM,),
    TAYDENNYSKOULUTUS_HEADERS: (T.EXCEL_OPPIJANUMERO, T.EXCEL_ETUNIMET, T.EXCEL_SUKUNIMI, T.EXCEL_HETU,
                                T.EXCEL_TURVAKIELTO, T.EXCEL_TYONTEKIJA_ID, T.EXCEL_LAHDEJARJESTELMA,
                                T.EXCEL_TAYDENNYSKOULUTUS_NIMI, T.EXCEL_TAYDENNYSKOULUTUS_ID,
                                T.EXCEL_TAYDENNYSKOULUTUS_TUNNISTE, T.EXCEL_SUORITUS_PVM, T.EXCEL_KOULUTUSPAIVIA,
                                T.EXCEL_TEHTAVANIMIKE,),
    TOIMIPAIKKA_HEADERS: (T.EXCEL_NIMI, T.EXCEL_OID, T.EXCEL_ID, T.EXCEL_LAHDEJARJESTELMA, T.EXCEL_TUNNISTE,
                          T.EXCEL_PALVELUNTUOTTAJA_NIMI, T.EXCEL_PALVELUNTUOTTAJA_OID, T.EXCEL_ALKAMIS_PVM,
                          T.EXCEL_PAATTYMIS_PVM, T.EXCEL_KASVATUSOPILLINEN_JARJESTELMA, T.EXCEL_TOIMINTAMUOTO,
                          T.EXCEL_TOIMINTAKIELI, T.EXCEL_JARJESTAMISMUOTO, T.EXCEL_VARHAISKASVATUSPAIKAT,
                          T.EXCEL_KUNTA, T.EXCEL_KAYNTIOSOITE, T.EXCEL_POSTINUMERO, T.EXCEL_POSTITOIMIPAIKKA,
                          T.EXCEL_POSTIOSOITE, T.EXCEL_POSTINUMERO, T.EXCEL_POSTITOIMIPAIKKA, T.EXCEL_PUHELINNUMERO,
                          T.EXCEL_EMAIL, T.EXCEL_PAINOTUS_ID, T.EXCEL_LAHDEJARJESTELMA, T.EXCEL_TUNNISTE,
                          T.EXCEL_TOIMINNALLINEN_PAINOTUS, T.EXCEL_KIELIPAINOTUS, T.EXCEL_KIELIPAINOTUS_TYYPPI,
                          T.EXCEL_ALKAMIS_PVM, T.EXCEL_PAATTYMIS_PVM,),
    VUOSIRAPORTTI_VARHAISKASVATUS_HEADERS: ('', T.EXCEL_KAIKKI_TIEDOT, T.EXCEL_OMAT_TIEDOT, T.EXCEL_PAOS_TIEDOT,),
    ...
    ExcelReportType.TAYDENNYSKOULUTUSTIEDOT.value: T.EXCEL_FILENAME_TAYDENNYSKOULUTUSTIEDOT,
...
class ExcelReportGenerator:
    ...
    def generate(self):
        ...
        if not encryption_result:
            logger.error(f'Error encrypting Excel file with ID {report.id}, size: {excel_log.file_size}, '
    ...
    def _create_vakatiedot_report(self, vakasuhde_filter=Q(), maksutieto_filter=Q()):
        if self.admin_user_all_organizations:
            ...
            select_related = ['varhaiskasvatuspaatos', 'varhaiskasvatuspaatos__lapsi',
        ...
        for index, vakasuhde in enumerate(vakasuhde_qs.iterator(), 1):
            ...
            self.henkilo_id_oid_set.add((henkilo.id, henkilo.henkilo_oid,))
        ...
        if not self.toimipaikka_id and not self.admin_user_all_organizations:
            ...
            for index, maksutieto in enumerate(maksutieto_qs.iterator(chunk_size=1000), 1):
                ...
                self.henkilo_id_oid_set.add((maksutieto.henkilo_id, maksutieto.henkilo_oid,))
    ...
    def _create_tyontekijatiedot_report(self, palvelussuhde_filter=Q()):
        ...
        palvelussuhde_qs = (
            Palvelussuhde.objects.filter(vakajarjestaja_filter & palvelussuhde_filter).distinct()
        ...
        for palvelussuhde in palvelussuhde_qs.iterator(chunk_size=500):
            ...
            for type_index, data_set in enumerate((tyoskentelypaikka_qs,
                ...
                for data_instance in data_set:
                    ...
                    filtered_tutkinnot = [
                        tutkinto for tutkinto in palvelussuhde.tyontekija.henkilo.tutkinnot.all()
    ...
    def _create_taydennyskoulutustiedot_report(self):
        ...
        taydennyskoulutus_sheet = self._add_worksheet(T.EXCEL_TAYDENNYSKOULUTUS_PLURAL)
            ...
            for painotus in painotus_list:
                ...
                if not isinstance(painotus, TemporaryObject):
                    ...
                    if hasattr(painotus, 'toimintapainotus_koodi'):
                        toimipaikka_values.extend([
                            _get_code_translation(toiminnallinen_painotus_codes, painotus.toimintapainotus_koodi),
                            None,
                            None
                        ])
    ...
    def _create_vuosiraportti_varhaiskasvatus(self, tilasto_date, poiminta_datetime):
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VAKATOIMIJA_NIMI),
                                       getattr(organisaatio, 'nimi', '')],
                        align_right_index_list=[1])
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VAKATOIMIJA_VOIMASSA),
                                       self._get_boolean_translation(organisaatio_active)],
                        align_right_index_list=[1])
        index += 2
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VARHAISKASVATUSPAIKAT_MAARA),
                                       varhaiskasvatuspaikat_sum])
        index += 1
        ...
        kielipainotus_count = get_yearly_report_kielipainotus_count(poiminta_datetime, tilasto_date,
                                                                    self.organisaatio_id)
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_TOIMINNALLINEN_PAINOTUS_PLURAL),
                                       toiminnallinen_painotus_count])
        index += 1
        ...
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_HENKILO_PLURAL),
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_LAPSI_PLURAL),
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_LAPSI_OSAPAIVAINEN),
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_LAPSI_KOKOPAIVAINEN),
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_LAPSI_VUOROHOITO),
        ...
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VARHAISKASVATUSSUHDE_PLURAL),
        ...
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VARHAISKASVATUSPAATOS_PLURAL),
        ...
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_MAKSUTIETO_PLURAL),
        ...
        if organisaatio_yritysmuoto in YRITYSMUOTO_KUNTA:
            ...
            index += 1
            self._write_row(sheet, index, [
                self._get_translation(T.EXCEL_TILASTOINTIPAIVAMAARA),
                latest_tilastointi_pvm if latest_tilastointi_pvm else '-'])
            index += 2
            self._write_row(sheet, index, [
                self._get_translation(T.EXCEL_TUKIPAATOSTIEDOT)])
            index += 1
    ...
    def _create_vuosiraportti_henkilosto(self, tilasto_date, poiminta_datetime):
        ...
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_TYONTEKIJA_PLURAL),
        ...
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_TYONTEKIJA_TEHTAVANIMIKE_MULTIPLE),
                                       multiple_tehtavanimike_count])
        index += 2
        ...
        index_temp = index + len(tn_codes) + 2
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_TAYDENNYSKOULUTUS_TYONTEKIJA_BY_TEHTAVANIMIKE)])
        index += 1
        self._write_row(sheet, index_temp, [self._get_translation(T.EXCEL_KOULUTUSPAIVIA_BY_TEHTAVANIMIKE)])
        index_temp += 1

        for tn_code in tn_codes:
            code_translation = _get_code_translation(tn_translations, tn_code)
            tyontekija_count = _get_nested_value(taydennyskoulutus_data, [tn_code], 'henkilo_count')
        ...
        vuokrattu_henkilosto_data = get_yearly_report_vuokrattu_henkilosto_data(poiminta_datetime, tilasto_date,
                                                                                self.organisaatio_id)

        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VUOKRATTU_HENKILOSTO_TYONTEKIJAMAARA),
                                       vuokrattu_henkilosto_data[0]])
        index += 1
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_VUOKRATTU_HENKILOSTO_TUNTIMAARA),
                                       vuokrattu_henkilosto_data[1]])
        index += 2

        month_translation_list = [
            self._get_translation(T.EXCEL_JANUARY), self._get_translation(T.EXCEL_FEBRUARY),
            self._get_translation(T.EXCEL_MARCH), self._get_translation(T.EXCEL_APRIL),
            self._get_translation(T.EXCEL_MAY), self._get_translation(T.EXCEL_JUNE),
            self._get_translation(T.EXCEL_JULY), self._get_translation(T.EXCEL_AUGUST),
            self._get_translation(T.EXCEL_SEPTEMBER), self._get_translation(T.EXCEL_OCTOBER),
            self._get_translation(T.EXCEL_NOVEMBER), self._get_translation(T.EXCEL_DECEMBER),
        ]
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_FIXED_TERM_EMPLOYMENT)])
        index += 1
        fixed_term_count = get_yearly_report_fixed_term_data(poiminta_datetime, tilasto_date.year, 0,
                                                             self.organisaatio_id)
        self._write_row(sheet, index, [self._get_translation(T.EXCEL_WHOLE_YEAR), fixed_term_count])
        index += 1
        for month_index in range(1, 13):
            fixed_term_count = get_yearly_report_fixed_term_data(poiminta_datetime, tilasto_date.year, month_index,
                                                                 self.organisaatio_id)
...
def _encrypt_excel_file(file_path, password):
    ...
    with (
        ...
        requests.post(
            ...
            f'{settings.JAVA_URL}/upload', files={'excel': file, 'password': (None, password,)}, stream=True, verify=False
        ) as resp
    ):
