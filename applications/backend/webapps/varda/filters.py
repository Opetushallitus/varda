...
from varda.models import (Organisaatio, Toimipaikka, ToiminnallinenPainotus, KieliPainotus, Henkilo, Lapsi, Huoltaja,
                          ...
                          VuokrattuHenkilosto, Tutkinto, Tyontekija, Palvelussuhde, Tyoskentelypaikka,
                          PidempiPoissaolo, Taydennyskoulutus, TaydennyskoulutusTyontekija, Z2_Code, Tukipaatos)
    ...
    def get_schema_fields(self, view):
        ...
        for custom_parameter in custom_parameters:
            schema_fields.append(coreapi.Field(
                name=custom_parameter.name, location=custom_parameter.location, required=custom_parameter.required,
