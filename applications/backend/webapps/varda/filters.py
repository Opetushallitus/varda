        ...
        for custom_parameter in custom_parameters:
            schema_fields.append(
                coreapi.Field(
                    ...
                    location=custom_parameter.location,
                    required=custom_parameter.required,
                    schema=self._get_schema(custom_parameter.data_type, custom_parameter.description),
                )
            )
        return schema_fields

    def get_schema_operation_parameters(self, view):
        # OpenAPI support (browsable API)
        custom_parameters = getattr(view, "custom_parameters", ())
        schema_operations = []
        for custom_parameter in custom_parameters:
