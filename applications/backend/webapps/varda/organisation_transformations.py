...
from varda.models import (Toimipaikka, Lapsi, Maksutieto, Huoltajuussuhde, Tyontekija, Tutkinto, Taydennyskoulutus,
                          TaydennyskoulutusTyontekija, VuokrattuHenkilosto, MaksutietoHuoltajuussuhde)
from varda.permission_groups import get_all_permission_groups_for_organization
from varda.permissions import (assign_taydennyskoulutus_permissions, assign_vuokrattu_henkilosto_permissions,
...
def _transfer_vuokrattu_henkilosto_permissions_to_new_vakajarjestaja(new_vakajarjestaja, old_vakajarjestaja):
    for vuokrattu_henkilosto in VuokrattuHenkilosto.objects.filter(vakajarjestaja=old_vakajarjestaja):
        existing_vuokrattu_henkilosto = (VuokrattuHenkilosto.objects
