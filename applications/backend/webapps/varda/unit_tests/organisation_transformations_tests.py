...
from varda.models import (Organisaatio, Toimipaikka, Varhaiskasvatussuhde, Varhaiskasvatuspaatos, Maksutieto, Lapsi,
                          ...
                          Palvelussuhde, Tutkinto, Tyontekija, Taydennyskoulutus, VuokrattuHenkilosto)
...
class OrganisationTransformationsTests(TestCase):
    ...
    def test_transfer_new_vakajarjestaja_has_existing_vuokrattu_henkilosto(self):
        ...
        self.assertEqual(vuokrattu_henkilosto.tuntimaara,
                         old_vuokrattu_henkilosto.tuntimaara + existing_vuokrattu_henkilosto.tuntimaara)
        self.assertEqual(vuokrattu_henkilosto.tyontekijamaara,
    ...
    def _assert_organization_has_permissions(self, organisaatio_oid, permission_id_list_nested, has_permissions=True):
        model_list = (Toimipaikka, ToiminnallinenPainotus, KieliPainotus, Henkilo, Lapsi, Varhaiskasvatuspaatos,
                      ...
                      PidempiPoissaolo, Taydennyskoulutus, VuokrattuHenkilosto,)
