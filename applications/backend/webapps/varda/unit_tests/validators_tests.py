...
class ValidatorsTests(TestCase):
    ...
    def test_validate_henkilotunnus_2023_reform(self):
        hetu_list = ['010594Y9021', '020594X903P', '020594X902N', '030594W903B', '030694W9024', '040594V9030',
                     '040594V902Y', '050594U903M', '050594U902L', '010516B903X', '010516B902W', '020516C903K',
                     '020516C902J', '030516D9037', '030516D9026', '010501E9032', '020502E902X', '020503F9037',
                     '020504A902E', '020504B904H']
    ...
    def test_validate_henkilotunnus_invalid(self):
        ...
        for hetu in invalid_control_character_cases:
            ...
            self.assertEqual(error.exception.detail, {
                'henkilotunnus': [
                    {'error_code': 'HE008', 'description': 'ID number or control character is incorrect.'}
                ]
            })
