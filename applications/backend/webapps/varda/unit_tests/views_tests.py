...
from varda.misc import hash_string, encrypt_string, decrypt_henkilotunnus
...
from varda.pagination import TestMaksutietoOrderCursorPagination
...
def mock_create_organisaatio(organisaatio_json):
    return {"toimipaikka_created": True, "organisaatio_oid": "1.2.246.562.10.10234567891"}


def mock_create_invalid_organisaatio(organisaatio_json):
    # Faulty oid
    return {"toimipaikka_created": True, "organisaatio_oid": "1.2.246.562.00.10234567891"}
...
class VardaViewsTests(TestCase):
    ...
    def test_api_root_authenticated(self):
        ...
        api_root = {
            ...
            "tukipaatokset": "http://testserver/api/v1/tukipaatokset/",
        }
        assert_status_code(resp, status.HTTP_200_OK)
    ...
    def test_api_get_user_data_authenticated(self):
        ...
        result_json = {
            "toimintakieli_koodi": "sv",
            "email": "",
            "henkilo_oid": "1.2.345678910",
            "kayttajatyyppi": "VIRKAILIJA",
            "kayttooikeudet": [
                {"organisaatio": "1.2.246.562.10.9395737548810", "kayttooikeus": "VARDA-TALLENTAJA"},
                {"organisaatio": "1.2.246.562.10.9395737548811", "kayttooikeus": "VARDA-KATSELIJA"},
                {"organisaatio": "1.2.246.562.10.9395737548810", "kayttooikeus": "HUOLTAJATIETO_TALLENNUS"},
                {"organisaatio": "1.2.246.562.10.34683023489", "kayttooikeus": "HUOLTAJATIETO_TALLENNUS"},
            ],
            "username": "tester",
        }
        assert_status_code(resp, status.HTTP_200_OK)
    ...
    def test_api_toimipaikat_v2(self):
        client = SetUpTestClient("tester").client()
        resp = client.get("/api/v2/toimipaikat/")
        assert_status_code(resp, status.HTTP_200_OK)

    def test_api_toimipaikat_v3(self):
        client = SetUpTestClient("tester").client()
        resp = client.get("/api/v3/toimipaikat/")
        assert_status_code(resp, status.HTTP_200_OK)
    ...
    def test_api_push_non_unique_henkilo_etunimi_correct_sukunimi_wrong(self):
        henkilo_obj = Henkilo.objects.get(syntyma_pvm="1966-02-13", etunimet="Lasse", sukunimi="Manner")
        henkilo = {"henkilotunnus": "130266-915J", "etunimet": "Lasse Eemeli", "kutsumanimi": "Lasse", "sukunimi": "Palomäki"}
        expected_response = {
            ...
            "lapsi": [],
            "tyontekija": [],
            "luonti_pvm": henkilo_obj.luonti_pvm.isoformat().replace("+00:00", "Z"),
            "muutos_pvm": henkilo_obj.muutos_pvm.isoformat().replace("+00:00", "Z"),
        }
        client = SetUpTestClient("tester2").client()
    ...
    def test_api_push_non_unique_henkilo_etunimi_wrong_sukunimi_correct(self):
        henkilo_obj = Henkilo.objects.get(syntyma_pvm="1966-02-13", etunimet="Lasse", sukunimi="Manner")
        henkilo = {"henkilotunnus": "130266-915J", "etunimet": "Ville", "kutsumanimi": "Ville", "sukunimi": "Manner"}
        expected_response = {
            "url": "http://testserver/api/v1/henkilot/6/",
            "id": 6,
            "etunimet": "Lasse",
    ...
    def test_api_push_non_unique_henkilo_etunimi_wrong_sukunimi_wrong(self):
        henkilo = {"henkilotunnus": "130266-915J", "etunimet": "Hanna Karin", "kutsumanimi": "Karin", "sukunimi": "Palomäki"}
        client = SetUpTestClient("tester2").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
    ...
    def test_api_push_incorrect_henkilo(self):  # wrong henkilotunnus-beginning
        henkilo = {"henkilotunnus": "123465-123P", "etunimet": "Hanna Karin", "kutsumanimi": "Karin", "sukunimi": "Palomäki"}
        client = SetUpTestClient("tester").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
    ...
    def test_api_push_incorrect_henkilo_2(self):  # wrong henkilotunnus-end; should end with P
        henkilo = {"henkilotunnus": "120465-123B", "etunimet": "Hanna Karin", "kutsumanimi": "Hanna", "sukunimi": "Palomäki"}
        client = SetUpTestClient("tester").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(resp, "henkilotunnus", "HE008", "ID number or control character is incorrect.")

    def test_api_push_henkilo_empty_kutsumanimi_ok(self):
        henkilo = {"henkilotunnus": "130266-915J", "etunimet": "Lasse", "kutsumanimi": "", "sukunimi": "Manner"}
        client = SetUpTestClient("tester").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_200_OK)

    def test_api_push_henkilo_missing_kutsumanimi_ok(self):
        henkilo = {"henkilotunnus": "130266-915J", "etunimet": "Lasse", "sukunimi": "Manner"}
        client = SetUpTestClient("tester").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_200_OK)

    def test_api_push_incorrect_henkilo_5(self):  # wrong kutsumanimi
        henkilo = {"henkilotunnus": "030187-851M", "etunimet": "Hanna Karin", "kutsumanimi": "HannaKarin", "sukunimi": "Palomäki"}
        client = SetUpTestClient("tester").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
    ...
    def test_api_push_henkilo_oid_etunimi_correct_sukunimi_wrong(self):
        henkilo_obj = Henkilo.objects.get(henkilo_oid="1.2.246.562.24.58672764848")
        henkilo = {
        ...
        expected_response = {
            ...
            "sukunimi": "Virtanen",
            "henkilo_oid": "1.2.246.562.24.58672764848",
            "syntyma_pvm": henkilo_obj.syntyma_pvm.strftime("%Y-%m-%d"),
            "turvakielto": False,
    ...
    def test_api_push_henkilo_oid_not_yksiloity_in_oppijanumerorekisteri(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "henkilo_oid", "HE002", "Unfortunately this Henkilo cannot be added. Is the Henkilo yksiloity?"
        )
    ...
    def test_hae_henkilo_found_henkilotunnus(self):
        ...
        data = {"henkilotunnus": decrypt_henkilotunnus(henkilo.henkilotunnus)}
    ...
    def test_api_huoltajat_filtering(self):
        ...
        client = SetUpTestClient("credadmin").client()
        resp = client.get(
            "/api/admin/huoltajat/?sukunimi=Virtane&kayntiosoite=Torikatu%2011&postitoimipaikka=Lappeenranta&kotikunta_koodi=034&muutos_pvm=2017-04-12"
        )
    ...
    def test_api_get_lapsi_json(self):
        lapsi_json = {
            ...
            "varhaiskasvatuspaatokset_top": ["http://testserver/api/v1/varhaiskasvatuspaatokset/1/?format=json"],
            "lahdejarjestelma": "1",
    ...
    def test_api_oid_related_field_lapsi_nulls_allowed_in_creation(self):
        ...
        henkilo_obj = Henkilo.objects.get(henkilo_oid="1.2.246.562.24.2395579772673")
        henkilo = {
            "henkilotunnus": decrypt_henkilotunnus(henkilo_obj.henkilotunnus),
            "etunimet": "Pentti Jr",
            "kutsumanimi": "Pentti",
            "sukunimi": "Kivimäki",
        }
    ...
    def test_api_oid_related_field_varhaiskasvatuspaatos_toimipaikka_field_required(self):
        ...
        henkilo = {"henkilotunnus": "180315A901Y", "etunimet": "Anton", "kutsumanimi": "Anton", "sukunimi": "Kivimäki"}
        client = SetUpTestClient("tester2").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        self.assertEqual(resp.status_code, status.HTTP_201_CREATED)
        henkilo_url = json.loads(resp.content)["url"]
    ...
    def test_api_external_permissions_no_virkailija(self):
        client = SetUpTestClient("tester").client()
        expected_response = {"accessAllowed": False, "errorMessage": "loggedInUserOid was not found"}
        post_data = {
        ...
        resp = client.post("/api/onr/external-permissions/", post_data, **{"HTTP_X_PROXIED_FROM": settings.VARDA_FRONTEND_SECRET})
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(json.loads(resp.content), expected_response)

    def test_api_external_permissions_no_person(self):
        client = SetUpTestClient("tester").client()
        expected_response = {"accessAllowed": False, "errorMessage": "Person not found"}
        post_data = {
    ...
    def test_api_external_permissions_no_permissions(self):
        client = SetUpTestClient("tester").client()
        expected_response = {"accessAllowed": False, "errorMessage": ""}
        post_data = {
            "personOidsForSamePerson": ["1", "1.2.246.562.24.47279942650"],
            "organisationOids": ["string"],
            "loggedInUserRoles": ["string"],
    ...
    def test_api_external_permissions_has_permission(self):
        client = SetUpTestClient("tester").client()
        expected_response = {"accessAllowed": True, "errorMessage": ""}
        post_data = {
            "personOidsForSamePerson": ["1", "1.2.246.562.24.47279942650"],
            "organisationOids": ["string"],
            "loggedInUserRoles": ["string"],
        ...
        # Not proxied from frontend, no permissions
    ...
    def test_api_push_huoltaja_not_allowed(self):
        ...
        henkilo = {"henkilotunnus": "050990-431L", "etunimet": "Tobias Jonas", "kutsumanimi": "Tobias", "sukunimi": "Virkkunen"}
        client = SetUpTestClient("tester").client()
        resp = client.post("/api/v1/henkilot/", henkilo)
        assert_status_code(resp, status.HTTP_201_CREATED)
        henkilo_url = json.loads(resp.content)["url"]

        huoltaja = {"henkilo": henkilo_url}
        client = SetUpTestClient("credadmin").client()
    ...
    def test_api_get_vakajarjestaja_json(self):
        ...
        self.assertEqual(set(content), set(vakajarjestaja_json))
    ...
    def test_api_get_toimipaikat_json(self):
        toimipaikka_json = {
            ...
            "toiminnallisetpainotukset_top": ["http://testserver/api/v1/toiminnallisetpainotukset/1/?format=json"],
            "kielipainotukset_top": ["http://testserver/api/v1/kielipainotukset/1/?format=json"],
        ...
        content = json.loads(resp.content)
        content.pop("muutos_pvm", None)
        self.assertEqual(set(content), set(toimipaikka_json))

    def test_api_get_toimipaikat_v2_json(self):
        toimipaikka_json = {
            "url": "http://testserver/api/v2/toimipaikat/1/?format=json",
            "id": 1,
            "vakajarjestaja": "http://testserver/api/v1/vakajarjestajat/2/?format=json",
            "vakajarjestaja_oid": "1.2.246.562.10.93957375488",
            "toiminnallisetpainotukset_top": ["http://testserver/api/v1/toiminnallisetpainotukset/1/?format=json"],
        ...
        client = SetUpTestClient("tester").client()
        resp = client.get("/api/v2/toimipaikat/1/?format=json")
        content = json.loads(resp.content)
        content.pop("muutos_pvm", None)
        self.assertEqual(set(content), set(toimipaikka_json))
    ...
    def test_api_push_incorrect_email(self):
        ...
        vakajarjestaja_patch = {"sahkopostiosoite": "fake@helsinki.f"}
    ...
    def test_api_push_correct_toimipaikka(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "TP007", "Could not check duplicates from Organisaatiopalvelu. Please try again later."
        )
    ...
    def test_push_api_incorrect_kielipainotus(self):
        ...
        assert_validation_error(
            ...
            "errors",
            "KP001",
            "KieliPainotus with this kielipainotus_koodi already exists for toimipaikka on the given date range.",
        )
    ...
    def test_push_api_incorrect_toiminnallinenpainotus(self):
        ...
        assert_validation_error(
            ...
            "errors",
            "TO001",
            "ToiminnallinenPainotus with this toimintapainotus_koodi already exists for toimipaikka on the given date range.",
        )
    ...
    def test_push_incorrect_varhaiskasvatuspaatos_tuntimaara(self):
        ...
        client = SetUpTestClient("tester").client()
        resp = client.post(
            "/api/v1/varhaiskasvatuspaatokset/", json.dumps(varhaiskasvatuspaatos), content_type="application/json"
        )
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
    ...
    def test_push_api_varhaiskasvatuspaatos_date_validation(self):
        ...
        for application, start, end in ok_cases:
            varhaiskasvatuspaatos.update(hakemus_pvm=application, alkamis_pvm=start, paattymis_pvm=end)
    ...
    def test_push_api_varhaiskasvatuspaatos_date_validation_kunnallinen(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "paattymis_pvm", "MI021", "paattymis_pvm must be equal to or after 2019-01-01 for kunnallinen Lapsi."
        )
    ...
    def test_push_api_varhaiskasvatussuhde_date_validation(self):
        ...
        for start, end in ok_cases:
            varhaiskasvatussuhde.update(alkamis_pvm=start, paattymis_pvm=end)
    ...
    def test_api_get_maksutieto(self):
        ...
        expected_response = {
            ...
            "asiakasmaksu": "0.00",
            "huoltajat": [
                {"etunimet": "Pauliina", "henkilo_oid": "1.2.987654321", "sukunimi": "Virtanen"},
                {"etunimet": "Pertti", "henkilo_oid": "", "sukunimi": "Virtanen"},
            ],
            "id": 1,
            "lapsi": "http://testserver/api/v1/lapset/1/",
    ...
    def test_push_api_maksutieto_missing_huoltaja_hetu_or_oid(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, ["huoltajat", "0", "errors"], "HE004", "Either henkilotunnus or henkilo_oid is needed, but not both."
        )
    ...
    def test_push_api_maksutieto_correct_format_1(self):
        ...
        accepted_response = {
            "url": maksutieto_url,
            "id": returned_id,
            "huoltajat": [{"henkilo_oid": "", "henkilotunnus": "120386-109V", "etunimet": "Pertti", "sukunimi": "Virtanen"}],
    ...
    def test_push_api_maksutieto_yksityinen_1(self):
        ...
        accepted_response = {
            ...
            "huoltajat": [
                {"henkilo_oid": "1.2.987654321", "etunimet": "Pauliina", "sukunimi": "Virtanen"},
                {"henkilo_oid": "", "henkilotunnus": "120386-109V", "etunimet": "Pertti", "sukunimi": "Virtanen"},
            ],
            "lapsi": "http://testserver/api/v1/lapset/1/",
            "lapsi_tunniste": "testing-lapsi1",
            "maksun_peruste_koodi": "mp02",
    ...
    def test_push_api_maksutieto_yksityinen_2(self):
        ...
        maksutieto = {
            "huoltajat": [{"henkilotunnus": "260980-642C", "etunimet": "Maija", "sukunimi": "Mallikas"}],
    ...
    def test_push_api_maksutieto_yksityinen_date_validation(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "paattymis_pvm", "MA014", "paattymis_pvm must be equal to or after 2020-09-01 for yksityinen Lapsi."
        )
    ...
    def test_push_api_maksutieto_date_validation(self):
        ...
        * Give permissions to each of these for the tester user's org
        ...
        for start, end in ok_cases:
            maksutieto.update(alkamis_pvm=start, paattymis_pvm=end)
    ...
    def test_push_api_maksutieto_too_many_active_long_timeframe(self):
        maksutieto = {
            "huoltajat": [{"henkilo_oid": "1.2.987654321", "etunimet": "Pauliina", "sukunimi": "Virtanen"}],
            "lapsi": "/api/v1/lapset/1/",
            "maksun_peruste_koodi": "mp02",
            "palveluseteli_arvo": 120,
            "asiakasmaksu": 0,
    ...
    def test_push_api_maksutieto_no_varhaiskasvatuspaatos(self):
        ...
        assert_validation_error(
            ...
            "errors",
            "MA009",
            "Lapsi does not have Varhaiskasvatussuhde. Add Varhaiskasvatussuhde before adding Maksutieto.",
        )
    ...
    def test_api_maksutieto_distinct_order_by(self):
        ...
        with mock.patch(
            "varda.viewsets.MaksutietoViewSet.queryset", Maksutieto.objects.all().order_by("perheen_koko", "id").distinct()
        ), mock.patch("varda.viewsets.MaksutietoViewSet.pagination_class", TestMaksutietoOrderCursorPagination):
    ...
    def test_push_duplicate_paos_toiminta(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "PT004", "Combination of oma_organisaatio and paos_organisaatio fields should be unique."
        )
    ...
    def test_push_duplicate_paos_toiminta_2(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "PT005", "Combination of oma_organisaatio and paos_toimipaikka fields should be unique."
        )
    ...
    def test_delete_paos_toiminta_with_toimija_and_push_correct_paos_toiminta_organisaatio(self):
        ...
        Varhaiskasvatussuhde.objects.filter(
            toimipaikka=toimipaikka, varhaiskasvatuspaatos__lapsi__oma_organisaatio__organisaatio_oid="1.2.246.562.10.34683023489"
        ).delete()
        ...
        paos_toiminta = PaosToiminta.objects.get(
            oma_organisaatio__organisaatio_oid="1.2.246.562.10.93957375488",
        ...
        checker = ObjectPermissionChecker(vakajarjestaja_group)
        self.assertFalse(
            checker.has_perm("view_toimipaikka", toimipaikka), "Group should no longer have view access to toimipaikka"
        )
    ...
    def test_delete_paostoiminta_with_toimija_view_access_stays_if_children_in_toimipaikka(self):
        ...
        checker = ObjectPermissionChecker(vakajarjestaja_group)
        self.assertTrue(
            checker.has_perm("view_toimipaikka", toimipaikka), "Group should still have view access to toimipaikka with children"
        )
    ...
    def test_delete_paostoiminta_with_toimipaikka(self):
        ...
        paos_toiminta = PaosToiminta.objects.get(
            oma_organisaatio__organisaatio_oid="1.2.246.562.10.34683023489", paos_toimipaikka=toimipaikka
        )
        delete_resp = client.delete(f"/api/v1/paos-toiminnat/{paos_toiminta.id}/")
        assert_status_code(delete_resp, status.HTTP_204_NO_CONTENT)
        # ObjectPermissionChecker caches results so we need to make sure we init a new one
    ...
    def test_paos_toiminta_voimassa_kytkin_organisation_first(self):
        ...
        resp_organisaatio = client_tester3.post(
            "/api/v1/paos-toiminnat/", paos_toiminta_organisaatio, content_type="application/json"
        )
        ...
        resp_toimipaikka = client_tester4.post(
            "/api/v1/paos-toiminnat/", paos_toiminta_toimipaikka, content_type="application/json"
        )
    ...
    def test_nested_paos_toimipaikat_filter(self):
        ...
        resp_paos_toimipaikat = client.get(
            "/api/v1/vakajarjestajat/1/paos-toimipaikat/?organisaatio_oid=1.2.246.562.10.9395737548817"
        )
        resp_paos_toimipaikat_count = json.loads(resp_paos_toimipaikat.content)["count"]
        self.assertEqual(resp_paos_toimipaikat_count, 1)
    ...
    def test_paos_oikeus_change_tallentaja_organisaatio_correct_format(self):
        client_tester4 = SetUpTestClient("tester4").client()
        tallentaja_organisaatio = {"tallentaja_organisaatio": "/api/v1/vakajarjestajat/2/"}
        tallentaja_organisaatio = json.dumps(tallentaja_organisaatio)
        resp_paos_oikeus = client_tester4.patch(
            "/api/v1/paos-oikeudet/1/", tallentaja_organisaatio, content_type="application/json"
        )
    ...
    def test_paos_oikeus_change_tallentaja_organisaatio_already_is_same(self):
        ...
        assert_validation_error(
            resp_paos_oikeus, "tallentaja_organisaatio", "PO002", "tallentaja_organisaatio is already the same as requested."
        )
    ...
    def test_push_incorrect_puhelinnumero(self):
        ...
        for puhelinnumero in puhelinnumero_list:
            patch_body = {"puhelinnumero": puhelinnumero}
    ...
    def test_api_delete_lapsi_1(self):
        ...
        assert_validation_error(
            ...
            "errors",
            "LA003",
            "Cannot delete Lapsi. There are Maksutieto objects referencing it that need to be deleted first.",
        )
    ...
    def test_api_delete_lapsi_2(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "LA004", "Cannot delete Lapsi. There are objects referencing it that need to be deleted first."
        )
    ...
    def test_api_push_too_many_varhaiskasvatussuhde(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "VS013", "Lapsi already has 3 overlapping Varhaiskasvatussuhde on the given date range."
        )
    ...
    def test_api_get_vakajarjestaja_yhteenveto(self):
        ...
        # Timeframe which is active the whole year.
        TukipaatosAikavali.objects.create(alkamis_pvm="1900-01-01", paattymis_pvm="1900-12-31", tilastointi_pvm="1900-12-31")
        Tukipaatos.objects.create(
            vakajarjestaja=Organisaatio.objects.get(nimi="Tester organisaatio"),
            paatosmaara=6,
            ikaryhma_koodi="IR01",
            tuentaso_koodi="TT01",
            tilastointi_pvm="2020-12-31",
        )
        ...
        accepted_response = {
            ...
            "vuokrattu_henkilosto_maara_kuluva_vuosi": None,
            "vuokrattu_henkilosto_tunnit_kuluva_vuosi": None,
            "tuen_tiedot_kunnallinen_tt_01": 6,
            "tuen_tiedot_kunnallinen_tt_02": None,
            "tuen_tiedot_kunnallinen_tt_03": None,
            "tuen_tiedot_yksityinen_tt_01": None,
            "tuen_tiedot_yksityinen_tt_02": None,
            "tuen_tiedot_yksityinen_tt_03": None,
            "tuen_tiedot_kunnallinen_tt_01_date": "31.12.2020",
            "tuen_tiedot_kunnallinen_tt_02_date": None,
            "tuen_tiedot_kunnallinen_tt_03_date": None,
            "tuen_tiedot_yksityinen_tt_01_date": None,
            "tuen_tiedot_yksityinen_tt_02_date": None,
            "tuen_tiedot_yksityinen_tt_03_date": None,
            "is_kunta": False,
        }
    ...
    def test_api_multiple_toimintakieli(self):
        toimipaikka = {
            'vakajarjestaja': 'http://testserver/api/v1/vakajarjestajat/1/',
            'nimi': 'Testila',
            'kunta_koodi': '091',
    ...
    def test_api_filter_toimintakieli_1(self):
        client = SetUpTestClient("tester2").client()
        resp = client.get("/api/v2/toimipaikat/?toimintakieli_koodi=SV")
        self.assertEqual(json.loads(resp.content)["count"], 2)

    def test_api_filter_toimintakieli_2(self):
        client = SetUpTestClient("tester2").client()
        resp = client.get("/api/v2/toimipaikat/?toimintakieli_koodi=SE")
        self.assertEqual(json.loads(resp.content)["count"], 0)
    ...
    @mock.patch("varda.organisaatiopalvelu.create_organisaatio", mock_create_invalid_organisaatio)
    def test_api_toimipaikka_add_invalid_faulty_org_palvelu_oid(self):
        vakajarjestaja = Organisaatio.objects.get(organisaatio_oid="1.2.246.562.10.34683023489")
        ...
        client = SetUpTestClient("tester2").client()
        resp = client.post("/api/v1/toimipaikat/", toimipaikka)
        assert_status_code(resp, status.HTTP_500_INTERNAL_SERVER_ERROR)
        assert_validation_error(resp, "organisaatio_oid", "MI010", "Not an OID for an organization.")
    ...
    @mock.patch("varda.organisaatiopalvelu.check_if_toimipaikka_exists_by_name", mock_check_if_toimipaikka_exists_by_name)
    @mock.patch("varda.organisaatiopalvelu.create_organisaatio", mock_create_organisaatio)
    def test_api_v2_toimipaikka_add_valid(self):
        vakajarjestaja = Organisaatio.objects.get(organisaatio_oid="1.2.246.562.10.34683023489")
        ...
        client = SetUpTestClient("tester2").client()
        resp = client.post("/api/v2/toimipaikat/", toimipaikka)
        assert_status_code(resp, status.HTTP_201_CREATED)
    ...
    def test_api_vakapaatos_tilapainen_vaka_kytkin_required(self):
        lapsi_kunta = Lapsi.objects.get(
            henkilo__henkilo_oid="1.2.246.562.24.49084901392", vakatoimija__organisaatio_oid="1.2.246.562.10.34683023489"
        )
        vakapaatos_kunta = {
        ...
        assert_validation_error(
            resp_kunta_1, "tilapainen_vaka_kytkin", "VP014", "tilapainen_vaka_kytkin is required for kunnallinen Lapsi."
        )
        ...
        lapsi_yksityinen = Lapsi.objects.get(
            henkilo__henkilo_oid="1.2.246.562.24.47279942650", vakatoimija__organisaatio_oid="1.2.246.562.10.93957375488"
        )
    ...
    def test_api_toimipaikka_lahdejarjestelma_tunniste_get_put_patch(self):
        ...
        toimipaikka_patch = {"tunniste": tunniste}
    ...
    def test_api_toiminnallinen_painotus_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        painotus_patch = {"tunniste": tunniste}
    ...
    def test_api_vakapaatos_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        vakapaatos_patch = {"tunniste": tunniste}
    ...
    def test_api_vakasuhde_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        vakasuhde_patch = {"tunniste": tunniste}
    ...
    def test_api_maksutieto_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        maksutieto_patch = {"tunniste": tunniste}
    ...
    def test_toimipaikka_lapsi_create_all(self):
        ...
        henkilo = {"henkilo_oid": henkilo_oid, "etunimet": "Erkki", "kutsumanimi": "Erkki", "sukunimi": "Esimerkki"}
        ...
        assert_validation_error(
            resp_lapsi_2, "toimipaikka", "MI019", "Given Toimipaikka does not belong to the correct Organisaatio."
        )
        ...
        assert_validation_error(
            resp_vakapaatos_1, "toimipaikka", "MI019", "Given Toimipaikka does not belong to the correct Organisaatio."
        )
        ...
        assert_validation_error(
            resp_vakasuhde_1, "toimipaikka", "MI019", "Given Toimipaikka does not belong to the correct Organisaatio."
        )
    ...
    @responses.activate
    @patch.object(HenkiloViewSet, "validate_henkilo_uniqueness_henkilotunnus", mock_validate_henkilo_uniqueness_henkilotunnus)
    ...
    def test_henkilo_unique_constraint(self):
        ...
        henkilo_base = {"etunimet": "Erkki", "kutsumanimi": "Erkki", "sukunimi": "Esimerkki"}
        client = SetUpTestClient("tester2").client()
    ...
    def test_lapsi_unique_constraint(self):
        ...
        lapsi = {"henkilo_oid": henkilo_oid, "vakatoimija_oid": vakajarjestaja_oid, "lahdejarjestelma": "1"}
        ...
        assert_validation_error(
            ...
            "errors",
            "LA010",
            "Combination of henkilo, oma_organisaatio and paos_organisaatio fields should be unique.",
        )
    ...
    def test_lapsi_tyontekija(self):
        ...
        lapsi = {"henkilo_oid": henkilo_oid, "vakatoimija_oid": "1.2.246.562.10.34683023489", "lahdejarjestelma": "1"}
    ...
    def test_toimipaikka_dates_within_vakajarjestaja(self):
        ...
        assert_status_code(resp_1, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp_1, "alkamis_pvm", "TP025", "alkamis_pvm must be before or equal to Organisaatio paattymis_pvm."
        )
        ...
        assert_status_code(resp_2, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp_2, "paattymis_pvm", "TP024", "Toimipaikka must have paattymis_pvm because Organisaatio is not active."
        )
        ...
        assert_status_code(resp_2, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp_2, "paattymis_pvm", "TP026", "paattymis_pvm must be before or equal to Organisaatio paattymis_pvm."
        )
    ...
    def test_code_active_validation(self):
        ...
        for test_set in test_list:
            ...
            for invalid_case in invalid_cases:
                ...
                invalid_resp_post = client.post(
                    "/api/v1/varhaiskasvatuspaatokset/", json.dumps(vakapaatos_post), content_type="application/json"
                )
                assert_status_code(invalid_resp_post, status.HTTP_400_BAD_REQUEST)
                assert_validation_error(
                    invalid_resp_post, "jarjestamismuoto_koodi", "KO005", "Code is not active during the time period."
                )
                invalid_resp_patch = client.patch(
                    vakapaatos_patch_url,
                    json.dumps({"alkamis_pvm": invalid_case[0], "paattymis_pvm": invalid_case[1]}),
                    content_type="application/json",
                )
                assert_status_code(invalid_resp_patch, status.HTTP_400_BAD_REQUEST)
                assert_validation_error(
                    invalid_resp_patch, "jarjestamismuoto_koodi", "KO005", "Code is not active during the time period."
                )

            for valid_case in valid_cases:
                vakapaatos_post["alkamis_pvm"] = valid_case[0]
                vakapaatos_post["paattymis_pvm"] = valid_case[1]
                valid_resp_post = client.post(
                    "/api/v1/varhaiskasvatuspaatokset/", json.dumps(vakapaatos_post), content_type="application/json"
                )
                ...
                valid_resp_patch = client.patch(
                    vakapaatos_patch_url,
                    json.dumps({"alkamis_pvm": valid_case[0], "paattymis_pvm": valid_case[1]}),
                    content_type="application/json",
                )
    ...
    def test_maksutieto_update_huoltajat_add_correct(self):
        ...
        MaksutietoHuoltajuussuhde.objects.get(
            maksutieto__tunniste="testing-maksutieto6",
            huoltajuussuhde__huoltaja__henkilo__henkilo_oid="1.2.246.562.24.3367432256266",
        ).delete()

        maksutieto_put = {
            "lapsi_tunniste": "testing-lapsi11",
            "huoltajat_add": [{"henkilo_oid": "1.2.246.562.24.3367432256266", "etunimet": "Kirsi", "sukunimi": "Taavetti"}],
            "maksun_peruste_koodi": "mp03",
            "palveluseteli_arvo": "0.00",
            "asiakasmaksu": "50.00",
            "perheen_koko": 3,
        ...
        resp = client.put(
            "/api/v1/maksutiedot/1:testing-maksutieto6/", json.dumps(maksutieto_put), content_type="application/json"
        )
        assert_status_code(resp, status.HTTP_200_OK)
        maksutieto_huoltajuussuhde_qs = Maksutieto.objects.get(
            tunniste="testing-maksutieto6"
        ).maksutiedot_huoltajuussuhteet.order_by("id")
        self.assertEqual(
            maksutieto_huoltajuussuhde_qs[0].huoltajuussuhde.huoltaja.henkilo.henkilo_oid, "1.2.246.562.24.2434693467574"
        )
        self.assertEqual(
            maksutieto_huoltajuussuhde_qs[1].huoltajuussuhde.huoltaja.henkilo.henkilo_oid, "1.2.246.562.24.3367432256266"
        )
    ...
    def test_maksutieto_update_huoltajat_add_incorrect(self):
        ...
        maksutieto_patch = {"huoltajat_add": [{"henkilo_oid": "1.2.246.562.24.2434693467574"}]}
        resp = client.patch(url, json.dumps(maksutieto_patch), content_type="application/json")
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
    ...
    def test_maksutieto_too_many_huoltaja(self):
        ...
        maksutieto_patch = {"huoltajat_add": [huoltaja_list[1], *extra_huoltaja_list]}
        resp = client.patch(
    ...
    def test_lapsi_delete_all_paos_jarjestaja(self):
        ...
        paos_oikeus = PaosOikeus.objects.get(
            jarjestaja_kunta_organisaatio__organisaatio_oid="1.2.246.562.10.34683023489",
            tuottaja_organisaatio__organisaatio_oid="1.2.246.562.10.93957375488",
        )
        paos_oikeus_patch = {"tallentaja_organisaatio_oid": "1.2.246.562.10.93957375488"}
        ...
        paos_oikeus_patch = {"tallentaja_organisaatio_oid": "1.2.246.562.10.34683023489"}
        assert_status_code(admin_client.patch(f"/api/v1/paos-oikeudet/{paos_oikeus.id}/", paos_oikeus_patch), status.HTTP_200_OK)
    ...
    def test_lapsi_delete_all_paos_tuottaja(self):
        ...
        admin_client = SetUpTestClient("tester2").client()
        paos_oikeus = PaosOikeus.objects.get(
            jarjestaja_kunta_organisaatio__organisaatio_oid="1.2.246.562.10.93957375484",
            tuottaja_organisaatio__organisaatio_oid="1.2.246.562.10.93957375488",
        )
        paos_oikeus_patch = {"tallentaja_organisaatio_oid": "1.2.246.562.10.93957375488"}
        assert_status_code(admin_client.patch(f"/api/v1/paos-oikeudet/{paos_oikeus.id}/", paos_oikeus_patch), status.HTTP_200_OK)
    ...
    def _get_data_ids_for_lapsi(self, lapsi):
        return {
            ...
            "vakasuhde_id_list": list(
                Varhaiskasvatussuhde.objects.filter(varhaiskasvatuspaatos__lapsi=lapsi).values_list("id", flat=True)
            ),
            "huoltajuussuhde_id_list": list(lapsi.huoltajuussuhteet.all().values_list("id", flat=True)),
            "maksutieto_huoltajuussuhde_id_list": list(
                MaksutietoHuoltajuussuhde.objects.filter(huoltajuussuhde__lapsi=lapsi).values_list("id", flat=True)
            ),
            "maksutieto_id_list": list(Maksutieto.objects.filter(huoltajuussuhteet__lapsi=lapsi).values_list("id", flat=True)),
        }
    ...
    def _verify_lapsi_data_deletion(self, lapsi_data):
        ...
        self.assertEqual(
            MaksutietoHuoltajuussuhde.objects.filter(id__in=lapsi_data["maksutieto_huoltajuussuhde_id_list"]).count(), 0
        )
        self.assertEqual(Maksutieto.objects.filter(id__in=lapsi_data["maksutieto_id_list"]).count(), 0)

    def test_lapsi_kooste_oma(self):
        lapsi = Lapsi.objects.get(tunniste="testing-lapsi10")

        client_vaka = SetUpTestClient("tester5").client()
        client_maksutieto = SetUpTestClient("tester7").client()
        client_all = SetUpTestClient("pkvakajarjestaja2").client()
        client_toimipaikka = SetUpTestClient("tester").client()
        # user has permissions to multiple organizations so set active one before kooste request
        assert_status_code(
            client_toimipaikka.post("/api/ui/active-organisaatio/", {"organisaatio_oid": "1.2.246.562.10.93957375488"}),
            status.HTTP_200_OK,
        )
        client_invalid = SetUpTestClient("tester10").client()

        url_1 = f"/api/v1/lapset/{lapsi.id}/kooste/"
        url_2 = f"/api/v1/lapset/{lapsi.lahdejarjestelma}:{lapsi.tunniste}/kooste/"

        # No permissions
        assert_status_code(client_invalid.get(url_1), status.HTTP_404_NOT_FOUND)

        # Only vaka
        resp = client_vaka.get(url_2)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], lapsi.id)
        self.assertEqual(len(result["varhaiskasvatuspaatokset"]), lapsi.varhaiskasvatuspaatokset.count())
        self.assertEqual(
            len(result["varhaiskasvatussuhteet"]),
            lapsi.varhaiskasvatuspaatokset.values_list("varhaiskasvatussuhteet__id").count(),
        )
        self.assertEqual(len(result["maksutiedot"]), 0)

        # Only maksutiedot
        resp = client_maksutieto.get(url_2)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], lapsi.id)
        self.assertEqual(len(result["varhaiskasvatuspaatokset"]), 0)
        self.assertEqual(len(result["varhaiskasvatussuhteet"]), 0)
        self.assertEqual(len(result["maksutiedot"]), lapsi.huoltajuussuhteet.values_list("maksutiedot__id").distinct().count())

        # Only Toimipaikka 1.2.246.562.10.2935996863483
        resp = client_toimipaikka.get(url_1)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], lapsi.id)
        self.assertEqual(len(result["varhaiskasvatuspaatokset"]), 1)
        self.assertEqual(len(result["varhaiskasvatussuhteet"]), 1)
        # Has permissions to all Maksutieto objects
        self.assertEqual(len(result["maksutiedot"]), lapsi.huoltajuussuhteet.values_list("maksutiedot__id").distinct().count())

        # All
        resp = client_all.get(url_1)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], lapsi.id)
        self.assertEqual(len(result["varhaiskasvatuspaatokset"]), lapsi.varhaiskasvatuspaatokset.count())
        ...
        self.assertEqual(Z12_DataAccessLog.objects.count(), 4)
        for data_access_log in Z12_DataAccessLog.objects.all():
            self.assertEqual(data_access_log.henkilo_id, lapsi.henkilo.id)
            self.assertEqual(data_access_log.henkilo_oid, lapsi.henkilo.henkilo_oid)
            self.assertEqual(data_access_log.access_type, DataAccessType.KOOSTE.value)
            self.assertEqual(data_access_log.organisaatio.organisaatio_oid, "1.2.246.562.10.93957375488")

    def test_lapsi_kooste_paos(self):
        lapsi = Lapsi.objects.get(tunniste="testing-lapsi8")

        client_jarjestaja = SetUpTestClient("pkvakajarjestaja1").client()
        client_tuottaja = SetUpTestClient("pkvakajarjestaja2").client()
        client_toimipaikka_vaka = SetUpTestClient("tester8").client()
        client_toimipaikka_maksutieto = SetUpTestClient("tester9").client()
        client_invalid = SetUpTestClient("tester11").client()

        url = f"/api/v1/lapset/{lapsi.id}/kooste/"

        # No permissions
        assert_status_code(client_toimipaikka_maksutieto.get(url), status.HTTP_404_NOT_FOUND)
        assert_status_code(client_invalid.get(url), status.HTTP_404_NOT_FOUND)

        # Only vaka permissions in Toimipaikka 1.2.246.562.10.9395737548817
        resp = client_toimipaikka_vaka.get(url)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], lapsi.id)
        self.assertEqual(len(result["varhaiskasvatuspaatokset"]), 1)
        ...
        # No permissions to Maksutieto objects
        self.assertEqual(len(result["maksutiedot"]), 0)

        # Jarjestaja
        resp = client_jarjestaja.get(url)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], lapsi.id)
        self.assertEqual(len(result["varhaiskasvatuspaatokset"]), lapsi.varhaiskasvatuspaatokset.count())
        ...
        # Verify data access log
        self.assertEqual(Z12_DataAccessLog.objects.count(), 3)
        for data_access_log in Z12_DataAccessLog.objects.all():
            self.assertEqual(data_access_log.henkilo_id, lapsi.henkilo.id)
            self.assertEqual(data_access_log.henkilo_oid, lapsi.henkilo.henkilo_oid)
            self.assertEqual(data_access_log.access_type, DataAccessType.KOOSTE.value)
            if data_access_log.user.username == "pkvakajarjestaja1":
                self.assertEqual(data_access_log.organisaatio.organisaatio_oid, "1.2.246.562.10.34683023489")
            else:
                self.assertEqual(data_access_log.organisaatio.organisaatio_oid, "1.2.246.562.10.93957375488")

    def test_put_toimipaikat_v3_organisaatio_oid_disallowed(self):
        lahdejarjestelma = "1"
        tunniste = "testing-toimipaikka2"
        ...
        resp = client.put(
            f"/api/v3/toimipaikat/{lahdejarjestelma}:{tunniste}/", json.dumps(data), content_type="application/json"
        )
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(resp, "organisaatio_oid", "GE013", "Changing of this field is not allowed.")

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_post_tukipaatos_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        # Timeframe which is active the whole year.
        TukipaatosAikavali.objects.create(alkamis_pvm="2021-01-01", paattymis_pvm="2021-12-31", tilastointi_pvm="2021-12-31")
        ...
        resp = client.post("/api/v1/tukipaatokset/", tukipaatos)
        assert_status_code(resp, status.HTTP_201_CREATED)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_get_tukipaatos_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        tukipaatos_id = json.loads(resp.content)["id"]
        resp = client.get(f"/api/v1/tukipaatokset/{tukipaatos_id}/")
        assert_status_code(resp, status.HTTP_200_OK)
        paatosmaara = json.loads(resp.content)["paatosmaara"]
        self.assertEqual(paatosmaara, 15)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_list_tukipaatos_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        resp = client.get("/api/v1/tukipaatokset/")
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(len(json.loads(resp.content)["results"]), 2)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_put_tukipaatos_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        tukipaatos_id = json.loads(resp.content)["id"]
        resp = client.put(f"/api/v1/tukipaatokset/{tukipaatos_id}/", tukipaatos_put)
        assert_status_code(resp, status.HTTP_200_OK)
        paatosmaara = json.loads(resp.content)["paatosmaara"]
        self.assertEqual(paatosmaara, 20)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_patch_tukipaatos_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        tukipaatos_id = json.loads(resp.content)["id"]
        resp = client.patch(f"/api/v1/tukipaatokset/{tukipaatos_id}/", tukipaatos_patch)
        assert_status_code(resp, status.HTTP_200_OK)
        paatosmaara = json.loads(resp.content)["paatosmaara"]
        self.assertEqual(paatosmaara, 20)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_delete_tukipaatos_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        tukipaatos_id = json.loads(resp.content)["id"]
        resp = client.delete(f"/api/v1/tukipaatokset/{tukipaatos_id}/", tukipaatos_patch)
        assert_status_code(resp, status.HTTP_204_NO_CONTENT)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-10-31")
    def test_post_tukipaatos_duplicates(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        resp = client.post("/api/v1/tukipaatokset/", tukipaatos_1)
        assert_status_code(resp, status.HTTP_201_CREATED)

        resp = client.post("/api/v1/tukipaatokset/", tukipaatos_2)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        validation_error_msg = (
            "The combination of vakajarjestaja_oid, yksityinen_jarjestaja, ikaryhma_koodi, "
            "tilastointi_pvm, tuentaso_koodi must be unique."
        )
        assert_validation_error(resp, "errors", "TT004", validation_error_msg)

    def test_post_tukipaatos_no_active_timeframes(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()
        ...
        resp = client.post("/api/v1/tukipaatokset/", tukipaatos)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(resp, "errors", "TT002", "There are currently no active timeframes.")

    @mock_date_decorator_factory("varda.serializers.datetime", "2020-10-31")
    def test_post_tukipaatos_outside_timeframe(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        # Timeframe which is active 2 months, starting from 1st of November, and ending 31st of December.
        TukipaatosAikavali.objects.create(alkamis_pvm="1900-11-01", paattymis_pvm="1900-12-31", tilastointi_pvm="1900-12-31")
        ...
        resp = client.post("/api/v1/tukipaatokset/", tukipaatos)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        validation_error_msg = "Tukipaatos can only be created or modified within defined timeframes."
        assert_validation_error(resp, "errors", "TT001", validation_error_msg)

    @mock_date_decorator_factory("varda.serializers.datetime", "2021-12-15")
    def test_tukipaatos_update_expired(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        TukipaatosAikavali.objects.create(alkamis_pvm="2021-12-01", paattymis_pvm="2022-01-31", tilastointi_pvm="2021-12-31")
        tukipaatos = {
            "vakajarjestaja": "/api/v1/vakajarjestajat/1/",
            "paatosmaara": "15",
            "yksityinen_jarjestaja": "false",
        ...
        # Call the second context function with its own mock_date_decorator_factory settings.
        self.tukipaatos_update_expired(client, resp)

    @mock_date_decorator_factory("varda.serializers.datetime", "2022-02-01")
    def tukipaatos_update_expired(self, client, resp):
        tukipaatos_put = {
            "vakajarjestaja": "/api/v1/vakajarjestajat/1/",
            "paatosmaara": "20",
            "yksityinen_jarjestaja": "false",
    ...
    @mock_date_decorator_factory("varda.serializers.datetime", "2021-01-15")
    def test_tukipaatos_update_within_timeframe_after_statistical_date(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        # Active timeframe
        TukipaatosAikavali.objects.create(alkamis_pvm="2020-12-01", paattymis_pvm="2021-01-31", tilastointi_pvm="2020-12-31")
        tukipaatos = {
            "vakajarjestaja": "/api/v1/vakajarjestajat/1/",
            "paatosmaara": "15",
            "yksityinen_jarjestaja": "false",
        ...
        resp = client.put(f"/api/v1/tukipaatokset/{tukipaatos_id}/", tukipaatos_put)
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(json.loads(resp.content)["ikaryhma_koodi"], "IR01")
        self.assertEqual(json.loads(resp.content)["tuentaso_koodi"], "TT01")

    @mock_date_decorator_factory("varda.serializers.datetime", "2023-10-31")
    def test_get_tukipaatos_specific_timeframe_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        # Timeframe which is active the whole year.
        TukipaatosAikavali.objects.create(alkamis_pvm="2023-01-01", paattymis_pvm="2023-12-31", tilastointi_pvm="2023-12-31")

        # Create 5 tukipaatos objects.
        for i in range(1, 6):
            tukipaatos = {
                "vakajarjestaja": "/api/v1/vakajarjestajat/1/",
                "paatosmaara": "15",
                "yksityinen_jarjestaja": "false",
                "ikaryhma_koodi": f"IR0{i}",
                "tuentaso_koodi": "TT01",
                "tunniste": f"tunniste{i}",
                "lahdejarjestelma": "1",
            }
            resp = client.post("/api/v1/tukipaatokset/", tukipaatos)
            assert_status_code(resp, status.HTTP_201_CREATED)

        # Should have 5 total tukipaatokset now
        resp = client.get("/api/v1/tukipaatokset/")
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(len(json.loads(resp.content)["results"]), 5)

        # Check that we get the correct tukipaatos with the given parameters
        tukipaatos_id = json.loads(resp.content)["results"][0]["id"]
        resp = client.get(f"/api/v1/tukipaatokset/{tukipaatos_id}/")
        assert_status_code(resp, status.HTTP_200_OK)
        paatosmaara = json.loads(resp.content)["ikaryhma_koodi"]
        self.assertEqual(paatosmaara, "IR01")

        # We should get only one tukipaatos with the given parameters
        resp = client.get(
            "/api/v1/tukipaatokset/?yksityinen_jarjestaja=false&ikaryhma_koodi=IR01&tuentaso_koodi=TT01"
            "&tilastointi_pvm=2023-12-31"
        )
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(len(json.loads(resp.content)["results"]), 1)
        paatosmaara = json.loads(resp.content)["results"][0]["ikaryhma_koodi"]
        self.assertEqual(paatosmaara, "IR01")

    @mock_date_decorator_factory("varda.viewsets.datetime", "2020-10-31")
    def test_get_tukipaatos_lists_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        # Timeframe which is active the whole year.
        TukipaatosAikavali.objects.create(alkamis_pvm="1900-12-01", paattymis_pvm="1900-01-31", tilastointi_pvm="1900-12-31")

        # Timeframe which is active the whole year.
        TukipaatosAikavali.objects.create(alkamis_pvm="1900-05-01", paattymis_pvm="1900-06-30", tilastointi_pvm="1900-05-31")

        resp = client.get("/api/v1/tukipaatokset/lists/")
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(json.loads(resp.content)["ikaryhma_koodi_list"][0], "IR01")
        self.assertEqual(json.loads(resp.content)["tuentaso_koodi_list"][0], "TT01")

    @mock_date_decorator_factory("varda.viewsets.datetime", "2020-12-05")
    def test_get_tukipaatos_lists_next_timeframe_success(self):
        client = SetUpTestClient("tukipaatos_tallentaja").client()

        # Timeframe which is active over year boundary.
        TukipaatosAikavali.objects.create(alkamis_pvm="2020-12-01", paattymis_pvm="2021-01-31", tilastointi_pvm="2020-12-31")

        # Timeframe which is active in the middle of the year.
        TukipaatosAikavali.objects.create(alkamis_pvm="2021-05-01", paattymis_pvm="2021-06-30", tilastointi_pvm="2021-05-31")

        resp = client.get("/api/v1/tukipaatokset/lists/")
        assert_status_code(resp, status.HTTP_200_OK)
        self.assertEqual(json.loads(resp.content)["next_aikavali"]["alkamis_pvm"], "2020-12-01")
        self.assertEqual(json.loads(resp.content)["next_aikavali"]["paattymis_pvm"], "2021-01-31")
        self.assertEqual(json.loads(resp.content)["next_aikavali"]["tilastointi_pvm"], "2020-12-31")

        self.get_tukipaatos_lists_next_timeframe_success(client)

    @mock_date_decorator_factory("varda.viewsets.datetime", "2021-03-15")
    def get_tukipaatos_lists_next_timeframe_success(self, client):
        resp = client.get("/api/v1/tukipaatokset/lists/")
        assert_status_code(resp, status.HTTP_200_OK)

        self.assertEqual(json.loads(resp.content)["next_aikavali"]["alkamis_pvm"], "2021-05-01")
        self.assertEqual(json.loads(resp.content)["next_aikavali"]["paattymis_pvm"], "2021-06-30")
        self.assertEqual(json.loads(resp.content)["next_aikavali"]["tilastointi_pvm"], "2021-05-31")
