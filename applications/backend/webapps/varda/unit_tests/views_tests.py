...
class VardaViewsTests(TestCase):
    ...
    def test_post_tukipaatos_success(self):
        ...
        TukipaatosAikavali.objects.create(
            alkamis_pvm='2021-01-01', paattymis_pvm='2021-12-31', tilastointi_pvm='2021-12-31')
    ...
    def test_tukipaatos_update_expired(self):
        ...
        TukipaatosAikavali.objects.create(
            alkamis_pvm='2021-12-01', paattymis_pvm='2022-01-31', tilastointi_pvm='2021-12-31')
        tukipaatos = {
            'vakajarjestaja': '/api/v1/vakajarjestajat/1/',
            'paatosmaara': '15',
            'yksityinen_jarjestaja': 'false',
    ...
    def test_tukipaatos_update_within_timeframe_after_statistical_date(self):
        ...
        # Active timeframe
        TukipaatosAikavali.objects.create(
            alkamis_pvm='2020-12-01', paattymis_pvm='2021-01-31', tilastointi_pvm='2020-12-31')
        tukipaatos = {
            'vakajarjestaja': '/api/v1/vakajarjestajat/1/',
            'paatosmaara': '15',
            'yksityinen_jarjestaja': 'false',
    ...
    def test_get_tukipaatos_specific_timeframe_success(self):
        ...
        # Timeframe which is active the whole year.
        TukipaatosAikavali.objects.create(
            alkamis_pvm='2023-01-01', paattymis_pvm='2023-12-31', tilastointi_pvm='2023-12-31')
        ...
        resp = client.get('/api/v1/tukipaatokset/?yksityinen_jarjestaja=false&ikaryhma_koodi=IR01&tuentaso_koodi=TT01'
    ...
    def test_get_tukipaatos_lists_next_timeframe_success(self):
        ...
        TukipaatosAikavali.objects.create(
            alkamis_pvm='2021-05-01', paattymis_pvm='2021-06-30', tilastointi_pvm='2021-05-31')
