...
from varda.filters import LapsiFilter, OrganisaatioFilter
...
class VardaModelsTests(TestCase):
    ...
    def test_organisaatio_oid_1(self):
        ...
        try:
            ...
            self.assertEqual(
                e.detail, {"organisaatio_oid": [{"error_code": "MI007", "description": "Number of OID sections is incorrect."}]}
            )
    ...
    def test_organisaatio_oid_2(self):
        ...
        try:
            ...
            self.assertEqual(
                e.detail, {"organisaatio_oid": [{"error_code": "MI008", "description": "OPH part of OID is incorrect."}]}
            )
    ...
    def test_organisaatio_oid_4(self):
        ...
        try:
            ...
            self.assertEqual(
                e.detail, {"organisaatio_oid": [{"error_code": "MI010", "description": "Not an OID for an organization."}]}
            )
