...
class VardaHenkilostoViewSetTests(RollbackTestCase):
    ...
    def test_api_push_tyontekija_correct(self):
        ...
        self._assert_create_and_list(
            client_katselija, client_tallentaja, tyontekija, "/api/henkilosto/v1/tyontekijat/", expected_count + 1
        )
    ...
    def test_api_tyontekija_filter(self):
        ...
        tyontekija_henkilo_count = Tyontekija.objects.filter(
            henkilo__henkilo_oid=tyontekija_oid, vakajarjestaja__organisaatio_oid=vakajarjestaja_oid
        ).count()
    ...
    def test_tyontekija_add_incorrect_vakajarjestaja(self):
        ...
        tyontekija = {"henkilo": "/api/v1/henkilot/1/", "vakajarjestaja": "/api/v1/vakajarjestajat/2/", "lahdejarjestelma": "1"}
    ...
    def test_tyontekija_add_twice(self):
        ...
        tyontekija = {"henkilo": "/api/v1/henkilot/1/", "vakajarjestaja": "/api/v1/vakajarjestajat/1/", "lahdejarjestelma": "1"}
    ...
    def test_tyontekija_add_twice_unique_constraint(self):
        ...
        assert_validation_error(
            resp_duplicate, "errors", "TY005", "Combination of henkilo and vakajarjestaja fields should be unique."
        )
    ...
    def test_api_push_tyontekija_tunniste(self):
        ...
        not_ok_cases = ["250700A5074", "illegal:characters", r"illegal\characters", "illegal/characters", "illegal_chäräcters"]
        ...
        resp = client.patch(
            "/api/henkilosto/v1/tyontekijat/1/",
            {
    ...
    def test_api_push_tyontekija_missing_henkilo(self):
        ...
        tyontekija = {"vakajarjestaja_oid": "1.2.246.562.10.34683023489", "tunniste": "tunniste", "lahdejarjestelma": "1"}
    ...
    def test_api_push_tyontekija_missing_vakajarjestaja(self):
        ...
        tyontekija = {"henkilo": "/api/v1/henkilot/1/", "lahdejarjestelma": "1", "tunniste": "tunniste"}
    ...
    def test_api_put_tyontekija_vakajarjestaja_edit(self):
        ...
        tyontekija_edit = {"vakajarjestaja": "/api/v1/vakajarjestajat/2/"}
    ...
    def test_api_push_tyontekija_henkilo_address_information_removed(self):
        ...
        self.assertTrue(
            henkilo_obj.kotikunta_koodi or henkilo_obj.katuosoite or henkilo_obj.postinumero or henkilo_obj.postitoimipaikka
        )
    ...
    def test_api_push_tyontekija_sahkopostiosoite_incorrect(self):
        ...
        tyontekija_patch_list = [{"sahkopostiosoite": "fake@helsinki.f"}, {"sahkopostiosoite": "almostcorrect.com"}]
    ...
    @mock_date_decorator_factory(datetime_path, "2020-12-01")
    def test_api_push_vuokrattu_henkilosto_correct_oid(
        self,
    ):
        client = SetUpTestClient("vuokrattu_tallentaja").client()
    ...
    def test_api_push_vuokrattu_henkilosto_delete(self):
        ...
        vuokrattu = VuokrattuHenkilosto.objects.create(
            vakajarjestaja=vakajarjestaja_tester, kuukausi="2019-09-01", tuntimaara=10.0, tyontekijamaara=10, lahdejarjestelma="1"
        )
    ...
    def test_api_push_vuokrattu_henkilosto_missing_vakajarjestaja(self):
        ...
        vuokrattu_henkilosto = {"kuukausi": "2020-10-31", "tuntimaara": "47.53", "tyontekijamaara": 5, "lahdejarjestelma": "1"}
    ...
    def test_api_put_vuokrattu_henkilosto_vakajarjestaja_edit(self):
        ...
        vuokrattu_henkilosto_edit = {"vakajarjestaja": "/api/v1/vakajarjestajat/2/"}
    ...
    def test_api_vuokrattu_henkilosto_filter(self):
        ...
        correct_queries_1 = [
            "?vakajarjestaja={0}&vuosi=2020&kuukausi=9".format(vakajarjestaja_id),
            "?vakajarjestaja={0}&vuosi=2020&kuukausi=9".format(vakajarjestaja_oid),
            "?vuosi=2020&kuukausi=9",
            "?kuukausi=9",
        ]

        correct_queries_2 = [
            "?vakajarjestaja={0}".format(vakajarjestaja_oid),
    ...
    def test_api_push_vuokrattu_henkilosto_kuukausi_in_allowed_period(self, mock_datetime):
        ...
        invalid_dates_period_1_2 = (
            "2022-07-01",
            "2022-12-01",
            "2023-01-01",
        )
        valid_dates_period_1 = (
            "2021-07-01",
            "2021-12-01",
            "2022-01-01",
            "2022-06-01",
        ...
        for test_case in test_cases:
            ...
            for invalid_case in test_case[2]:
                ...
                assert_status_code(resp, status.HTTP_400_BAD_REQUEST, f"{test_case[0], invalid_case}")
                assert_validation_error(
                    resp, "kuukausi", "TH007", "VuokrattuHenkilosto can be saved for either the current period or in the past."
                )
    ...
    def test_api_push_vuokrattu_henkilosto_in_advance(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "TH009", "tuntimaara and tyontekijamaara must be 0 if VuokrattuHenkilosto is saved in advance."
        )
    ...
    def test_api_push_tutkinto_correct(self):
        ...
        tutkinto = {"henkilo": "/api/v1/henkilot/1/", "vakajarjestaja": "/api/v1/vakajarjestajat/1/", "tutkinto_koodi": "002"}
    ...
    def test_api_push_tutkinto_twice(self):
        ...
        tutkinto_1 = {"henkilo": "/api/v1/henkilot/10/", "vakajarjestaja": "/api/v1/vakajarjestajat/1/", "tutkinto_koodi": "002"}
    ...
    def test_api_push_tutkinto_missing_henkilo(self):
        ...
        tutkinto = {"tutkinto_koodi": "321901"}
    ...
    def test_api_push_tutkinto_missing_tutkinto_koodi(self):
        ...
        tutkinto = {"henkilo_oid": "1.2.246.562.24.47279942650"}
    ...
    def test_api_delete_tutkinto(self):
        ...
        tutkinto = {"henkilo": "/api/v1/henkilot/1/", "vakajarjestaja": "/api/v1/vakajarjestajat/1/", "tutkinto_koodi": "719999"}

        resp = client.post("/api/henkilosto/v1/tutkinnot/", tutkinto)
        assert_status_code(resp, status.HTTP_201_CREATED)
        resp_delete = client.delete("/api/henkilosto/v1/tutkinnot/delete/?henkilo_id=1&tutkinto_koodi=719999&vakajarjestaja_id=1")
    ...
    def test_api_tutkinto_filter(self):
        ...
        tutkinto = {"henkilo_oid": henkilo_oid, "vakajarjestaja": "/api/v1/vakajarjestajat/1/", "tutkinto_koodi": "001"}
        resp = client.post("/api/henkilosto/v1/tutkinnot/", tutkinto)
        assert_status_code(resp, status.HTTP_201_CREATED)

        correct_queries = [
            "?henkilo={0}".format(henkilo_oid),
    ...
    def test_palvelussuhde_edit_allowed_and_delete(self):
        ...
        for key, value in palvelussuhde_edits.items():
            ...
            resp = client.put(
                f"/api/henkilosto/v1/palvelussuhteet/{palvelussuhde_id}/",
                json.dumps(palvelussuhde_edit),
    ...
    def test_palvelussuhde_add_too_many(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "PS006", "Tyontekija already has 7 overlapping Palvelussuhde on the given date range."
        )
    ...
    def test_palvelussuhde_add_and_edit_tyosuhde_koodi_2(self):
        ...
        palvelussuhde_patch = {"paattymis_pvm": None}

        palvelussuhde_id = json.loads(resp.content)["id"]
        resp = client.patch(
            f"/api/henkilosto/v1/palvelussuhteet/{palvelussuhde_id}/",
            json.dumps(palvelussuhde_patch),
            content_type="application/json",
        )
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
    ...
    def test_tyoskentelypaikka_add_correct(self):
        ...
        for version in ["v1", "v2"]:
            resp = client.post(
                f"/api/henkilosto/{version}/tyoskentelypaikat/", json.dumps(tyoskentelypaikka), content_type="application/json"
            )
            assert_status_code(resp, status.HTTP_201_CREATED)
    ...
    def test_tyoskentelypaikka_add_too_many(self):
        ...
        for i in range(2):
            resp = client.post(
                "/api/henkilosto/v1/tyoskentelypaikat/", json.dumps(tyoskentelypaikka), content_type="application/json"
            )
            assert_status_code(resp, status.HTTP_201_CREATED)
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, "errors", "TA011", "Palvelussuhde already has 3 overlapping Tyoskentelypaikka on the given date range."
        )
        ...
        tyoskentelypaikka.update(
            kiertava_tyontekija_kytkin=False,
            toimipaikka="/api/v1/toimipaikat/{}/".format(toimipaikka),
            alkamis_pvm="2022-02-02",
            paattymis_pvm="2023-03-03",
        )
        resp = client.post(
            "/api/henkilosto/v1/tyoskentelypaikat/", json.dumps(tyoskentelypaikka), content_type="application/json"
        )
    ...
    def test_tyoskentelypaikka_edit_allowed(self):
        ...
        for key, value in tyoskentelypaikka_edits.items():
            ...
            resp = client.put(
                "/api/henkilosto/v1/tyoskentelypaikat/{}/".format(tyoskentelypaikka_dict["id"]),
                json.dumps(tyoskentelypaikka_edit),
                content_type="application/json",
            )
            assert_status_code(resp, status.HTTP_200_OK, key)
    ...
    def test_tyoskentelypaikka_kiertava_disallows_toimipaikka(self):
        ...
        for version in ["v1", "v2"]:
            ...
            assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(
                resp, "kiertava_tyontekija_kytkin", "TA004", "Toimipaikka cannot be specified with kiertava_tyontekija_kytkin."
            )
    ...
    def test_tyoskentelypaikka_kelpoisuus_downgrade_allowed(self):
        ...
        resp = client.put(
            "/api/henkilosto/v1/tyoskentelypaikat/{}/".format(tyoskentelypaikka_dict["id"]),
            json.dumps(tyoskentelypaikka_dict),
            content_type="application/json",
        )
        assert_status_code(resp, status.HTTP_200_OK)
    ...
    def test_tyoskentelypaikka_incorrect_date_validation(self):
        ...
        cases = [
            ...
            (
                ...
                "paattymis_pvm",
                "TA006",
                "paattymis_pvm must be before or equal to Palvelussuhde paattymis_pvm.",
            ),
            (
                "2019-03-01",
                "2021-01-01",
                "alkamis_pvm",
                "TA008",
                "alkamis_pvm must be equal to or after Palvelussuhde alkamis_pvm.",
            ),
            (
                "2031-03-01",
                "2032-01-01",
                "alkamis_pvm",
                "TA009",
                "alkamis_pvm must be before or equal to Palvelussuhde paattymis_pvm.",
            ),
            ...
            (
                ...
                "paattymis_pvm",
                "TA013",
                "Tyoskentelypaikka must have paattymis_pvm because Palvelussuhde has paattymis_pvm.",
            ),
        ]
        ...
        for version in ["v1", "v2"]:
            for start, end, key, expected_error_code, expected_message in cases:
                ...
                resp = client.post(
                    f"/api/henkilosto/{version}/tyoskentelypaikat/",
    ...
    def test_tyoskentelypaikka_non_kiertava_overlaps_kiertava(self):
        ...
        # This should fail.
        tyoskentelypaikka.update(
            toimipaikka=None, kiertava_tyontekija_kytkin=True, alkamis_pvm="2025-05-01", paattymis_pvm="2025-12-31"
        )
        resp = client.post(
            "/api/henkilosto/v1/tyoskentelypaikat/", json.dumps(tyoskentelypaikka), content_type="application/json"
        )
    ...
    def test_tyoskentelypaikka_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        tyoskentelypaikka_patch = {"alkamis_pvm": "2020-03-01", "paattymis_pvm": "2020-09-02"}
    ...
    def test_tyoskentelypaikka_delete_invalid(self):
        ...
        assert_validation_error(
            ...
            "tehtavanimike_koodi",
            "TA002",
            "Cannot delete Tyoskentelypaikka. Taydennyskoulutus objects with this tehtavanimike_koodi must be deleted first.",
        )
    ...
    def test_tyoskentelypaikka_tehtavanimike_patch_invalid(self):
        ...
        client = SetUpTestClient("tyontekija_tallentaja").client()
        resp = client.patch(f"/api/henkilosto/v1/tyoskentelypaikat/{lahdejarjestelma}:{tunniste}/", tyoskentelypaikka_patch)
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp,
            "tehtavanimike_koodi",
            "TA015",
            "Cannot change tehtavanimike_koodi. There are Taydennyskoulutus objects that use this tehtavanimike_koodi.",
        )
    ...
    def test_pidempipoissaolo_add_correct(self):
        ...
        resp = client.post(
            "/api/henkilosto/v1/pidemmatpoissaolot/", json.dumps(pidempipoissaolo), content_type="application/json"
        )
        assert_status_code(resp, status.HTTP_201_CREATED)
    ...
    def test_pidempipoissaolo_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        pidempi_poissaolo_patch = {"alkamis_pvm": "2020-03-01", "paattymis_pvm": "2020-09-02"}
    ...
    def test_taydennyskoulutus_add_correct(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp = client.post(
                f"/api/henkilosto/{version}/taydennyskoulutukset/", json.dumps(taydennyskoulutus), content_type="application/json"
            )
            assert_status_code(resp, status.HTTP_201_CREATED)
    ...
    def test_taydennyskoulutus_add_fail_suoritus_pvm_after_2024_12_31(self):
        ...
        for version in ["v1", "v2"]:
            ...
            assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(resp, ["suoritus_pvm"], "TK018", "suoritus_pvm must be equal to or before 2024-12-31.")
    ...
    def test_taydennyskoulutus_update_fail_suoritus_pvm_after_2024_12_31(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp = client.put(
                f"{url_base}{taydennyskoulutus_qs.first().id}/",
                json.dumps(taydennyskoulutus_put),
                content_type="application/json",
            )
            assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(resp, ["suoritus_pvm"], "TK018", "suoritus_pvm must be equal to or before 2024-12-31.")
    ...
    def test_taydennyskoulutus_get_filtering(self):
        ...
        for version in ["v1", "v2"]:
            ...
            taydennyskoulutus = {
                "taydennyskoulutus_tyontekijat": [
                    {
                        "tyontekija": f"http://testserver/api/henkilosto/v1/tyontekijat/{tyontekija1.id}/",
                        "tehtavanimike_koodi": "39407",
                    }
                ],
                "nimi": "Ensiapukoulutus",
    ...
    def test_taydennyskoulutus_add_incorrect_tehtavanimike(self):
        ...
        resp = client.post(
            "/api/henkilosto/v2/taydennyskoulutukset/", json.dumps(taydennyskoulutus), content_type="application/json"
        )
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp,
    ...
    def test_taydennyskoulutus_add_invalid_tyontekija(self):
        ...
        cases = [
            ...
            [
                {
                    ...
                    "henkilo_oid": tyontekija2.henkilo.henkilo_oid,
                    "vakajarjestaja_oid": tyontekija2.vakajarjestaja.organisaatio_oid,
                },
                ["taydennyskoulutus_tyontekijat", "0", "henkilo_oid"],
                "TK005",
            ...
            [
                {
                    "henkilo_oid": tyontekija1.henkilo.henkilo_oid,
                    "vakajarjestaja_oid": tyontekija1.vakajarjestaja.organisaatio_oid,
                    "tunniste": tyontekija2.tunniste,
                    "lahdejarjestelma": tyontekija2.lahdejarjestelma,
                },
                ["taydennyskoulutus_tyontekijat", "0", "tunniste"],
                "TK007",
    ...
    def test_taydennyskoulutus_update_tyontekijat_incorrect(self):
        ...
        taydennyskoulutus_put = {
            "taydennyskoulutus_tyontekijat": [
                {"tehtavanimike_koodi": "84724", "tyontekija": f"/api/henkilosto/v1/tyontekijat/{tyontekija_1_obj.id}/"},
                {
                    "tehtavanimike_koodi": "77826",
                    "henkilo_oid": tyontekija_4_obj.henkilo.henkilo_oid,
                    "vakajarjestaja_oid": tyontekija_4_obj.vakajarjestaja.organisaatio_oid,
        ...
        resp_put = client.put(
            f"/api/henkilosto/v1/taydennyskoulutukset/{taydennyskoulutus_qs.first().id}/",
            json.dumps(taydennyskoulutus_put),
            content_type="application/json",
        )
        ...
        for version in ["v1", "v2"]:
            ...
            assert_validation_error(
                resp_patch, ["taydennyskoulutus_tyontekijat", "0", "tehtavanimike_koodi"], "KO003", "Not a valid code."
            )
            ...
            TaydennyskoulutusTyontekija.objects.get(
                tyontekija=tyontekija_1_obj, taydennyskoulutus__tunniste="testing-taydennyskoulutus1", tehtavanimike_koodi="64212"
            ).delete()
    ...
    def test_taydennyskoulutus_update_tyontekijat_add_correct(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp_put = client.put(
                f"/api/henkilosto/{version}/taydennyskoulutukset/{taydennyskoulutus_qs.first().id}/",
                json.dumps(taydennyskoulutus_put),
                content_type="application/json",
            )
            assert_status_code(resp_put, status.HTTP_200_OK)
            taydennyskoulutus_tyontekija_qs = taydennyskoulutus_qs.first().taydennyskoulutukset_tyontekijat.filter(
                tyontekija=tyontekija_1_obj
            )
    ...
    def test_taydennyskoulutus_update_tyontekijat_add_incorrect(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp_patch = client.patch(
                f"{base_url}{taydennyskoulutus_qs.first().id}/",
                json.dumps(taydennyskoulutus_patch),
                content_type="application/json",
            )
            assert_status_code(resp_patch, status.HTTP_400_BAD_REQUEST)
            ...
            assert_status_code(resp_patch, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(
                resp_patch, ["taydennyskoulutus_tyontekijat_add", "0", "tehtavanimike_koodi"], "KO003", "Not a valid code."
            )
    ...
    def test_taydennyskoulutus_update_tyontekijat_remove_incorrect(self):
        ...
        for version in ["v1", "v2"]:
            ...
            assert_status_code(resp_patch, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(
                resp_patch, "taydennyskoulutus_tyontekijat_remove", "TK012", "Tyontekija must have this Taydennyskoulutus."
            )
    ...
    def test_taydennyskoulutus_update_remove_all(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp_patch = client.patch(
                f"{base_url}{taydennyskoulutus_obj.id}/", json.dumps(taydennyskoulutus_patch), content_type="application/json"
            )
            assert_status_code(resp_patch, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(
                resp_patch,
    ...
    def test_taydennyskoulutus_update_tyontekijat_add_and_remove_correct(self):
        ...
        for version in ["v1", "v2"]:
            # Delete TaydennyskoulutusTyontekija so that we can add it again
            TaydennyskoulutusTyontekija.objects.get(
                tyontekija=tyontekija_4_obj, taydennyskoulutus__tunniste="testing-taydennyskoulutus1", tehtavanimike_koodi="77826"
            ).delete()
            ...
            self.assertEqual(
                taydennyskoulutus_qs.first()
                .taydennyskoulutukset_tyontekijat.filter(tehtavanimike_koodi__in=["39407", "77826"])
                .count(),
                2,
            )
    ...
    def test_taydennyskoulutus_lahdejarjestelma_tunniste_get_put_patch_delete(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp_taydennyskoulutus_put = client.put(
                taydennyskoulutus_url, json.dumps(taydennyskoulutus_put), content_type="application/json"
            )
            assert_status_code(resp_taydennyskoulutus_put, status.HTTP_200_OK)

            taydennyskoulutus_patch = {"suoritus_pvm": "2020-11-01", "koulutuspaivia": "3.5"}
    ...
    def test_taydennyskoulutus_tyontekija_list(self):
        client = SetUpTestClient("taydennyskoulutus_tallentaja").client()
        vakajarjestaja_oid = "1.2.246.562.10.34683023489"
        correct_taydennyskoulutus_count = (
            Taydennyskoulutus.objects.filter(
                taydennyskoulutukset_tyontekijat__tyontekija__vakajarjestaja__organisaatio_oid=vakajarjestaja_oid
            )
            .distinct()
            .count()
        )
        correct_jarjestaja_tyontekija_count = Tyontekija.objects.filter(
    ...
    def test_taydennyskoulutus_tyontekija_list_filter(self):
        ...
        for version in ["v1", "v2"]:
            ...
            tyontekija_list_filtered_resp = client.get(
                f"/api/henkilosto/{version}/taydennyskoulutukset/tyontekija-list/?vakajarjestaja_oid={vakajarjestaja_oid}"
            )
    ...
    def test_taydennyskoulutus_toimipaikka_permissions(self):
        ...
        for version in ["v1", "v2"]:
            ...
            resp_patch = client_toimipaikka.patch(
                f"{base_url}{taydennyskoulutus_1_id}/", json.dumps(taydennyskoulutus_1_patch), content_type="application/json"
            )
            assert_status_code(resp_patch, status.HTTP_400_BAD_REQUEST)
            assert_validation_error(
                resp_patch,
                ["taydennyskoulutus_tyontekijat_add", "0", "errors"],
                "TK001",
                "Tyontekija not specified. Use (tyontekija), (henkilo_oid, vakajarjestaja_oid) or (lahdejarjestelma, tunniste).",
            )
            resp_patch = client_jarjestaja.patch(
                f"{base_url}{taydennyskoulutus_1_id}/", json.dumps(taydennyskoulutus_1_patch), content_type="application/json"
            )
            assert_status_code(resp_patch, status.HTTP_200_OK)
            ...
            assert_validation_error(
                resp_delete, "errors", "TK014", "Insufficient permissions to Taydennyskoulutus related Tyontekija objects."
            )
    ...
    def test_taydennyskoulutus_create_v2(self):
        ...
        assert_status_code(resp, status.HTTP_400_BAD_REQUEST)
        assert_validation_error(
            resp, ["taydennyskoulutus_tyontekijat", "0", "tyontekija"], "GE008", "Invalid hyperlink, object does not exist."
        )
    ...
    def test_taydennyskoulutus_update_v2(self):
        ...
        assert_validation_error(
            resp,
            ["taydennyskoulutus_tyontekijat_remove", "0", "errors"],
            "TK016",
            "At least 1 valid Tyontekija is required (Tyontekija not found or tehtavanimike_koodi is incorrect).",
        )
    ...
    def test_taydennyskoulutus_update_unique_nimi_suoritus_pvm_koulutuspaiva_fail(self):
        ...
        taydennyskoulutus = Taydennyskoulutus.objects.filter(lahdejarjestelma=1, tunniste="testing-taydennyskoulutus1").first()
        ...
        for version in ["v1", "v2"]:
            taydennyskoulutus_update = {
                ...
                "lahdejarjestelma": "1",
                "taydennyskoulutus_tyontekijat_add": [
                    {"tyontekija": f"/api/henkilosto/v1/tyontekijat/{tyontekija.id}/", "tehtavanimike_koodi": "64212"}
                ],
            }
            resp_put = client.put(
                f"/api/henkilosto/{version}/taydennyskoulutukset/{taydennyskoulutus.id}/",
                json.dumps(taydennyskoulutus_update),
                content_type="application/json",
            )
    ...
    def test_toimipaikka_tyontekija_create_all(self):
        ...
        tyontekija_resp = self._assert_create_and_list(
            client_tyontekija_katselija,
            client_tyontekija_tallentaja,
            tyontekija,
        ...
        self._assert_create_and_list(
            client_tyontekija_katselija, client_tyontekija_tallentaja, tutkinto, "/api/henkilosto/v1/tutkinnot/", expected_count=2
        )
        ...
        palvelussuhde_resp = self._assert_create_and_list(
            client_tyontekija_katselija,
            client_tyontekija_tallentaja,
            palvelussuhde,
        ...
        create_response = client_tyontekija_tallentaja.post(
            "/api/henkilosto/v1/pidemmatpoissaolot/", json.dumps(pidempipoissaolo), content_type="application/json"
        )
        ...
        tyoskentelypaikka_resp = client_tyontekija_tallentaja.post(
            "/api/henkilosto/v1/tyoskentelypaikat/", json.dumps(tyoskentelypaikka), content_type="application/json"
        )
        ...
        self._assert_create_and_list(
            client_tyontekija_katselija, client_tyontekija_tallentaja, pidempipoissaolo, "/api/henkilosto/v1/pidemmatpoissaolot/"
        )
    ...
    def test_tyontekija_kooste(self):
        ...
        user.groups.set(
            Group.objects.filter(
                name__startswith=Z4_CasKayttoOikeudet.HENKILOSTO_TYONTEKIJA_TALLENTAJA,
        ...
        user.groups.set(Group.objects.filter(name__startswith="HENKILOSTO_", name__endswith="1.2.246.562.10.2565458382544"))
        resp = client.get(url)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], tyontekija.id)
        ...
        user.groups.set(Group.objects.filter(name__startswith="HENKILOSTO_", name__endswith="1.2.246.562.10.6727877596658"))
        resp = client.get(url)
        assert_status_code(resp, status.HTTP_200_OK)
        result = json.loads(resp.content)
        self.assertEqual(result["id"], tyontekija.id)
    ...
    def test_tyoskentelypaikka_vaka_avustaja_add_update_correct_kelpoisuus_true(self):
        ...
        tyoskentelypaikka_objs = Tyoskentelypaikka.objects.filter(
            palvelussuhde=palvelussuhde, toimipaikka=toimipaikka, tehtavanimike_koodi=TEHTAVANIMIKE_KOODI_VAKA_AVUSTAJA
        )
        ...
        resp = client.put(
            f'/api/henkilosto/v1/tyoskentelypaikat/{tyoskentelypaikka_dict["id"]}/',
            json.dumps(tyoskentelypaikka_dict),
            content_type="application/json",
        )
        assert_status_code(resp, status.HTTP_200_OK)
    ...
    def test_henkilo_tyontekija_tutkinto_duplicate_already_exists(self):
        ...
        tyontekija = {"henkilo_oid": henkilo_oid, "vakajarjestaja_oid": "1.2.246.562.10.34683023489", "lahdejarjestelma": "1"}
        ...
        tutkinto = {"henkilo_oid": henkilo_oid, "vakajarjestaja_oid": "1.2.246.562.10.34683023489", "tutkinto_koodi": "002"}
    ...
    def test_tyontekija_delete_all_vakajarjestaja(self):
        ...
        taydennyskoulutus_group = Group.objects.get(
            name=f"{Z4_CasKayttoOikeudet.HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA}_{organisaatio_oid}"
        )
    ...
    def test_tyontekija_delete_all_toimipaikka(self):
        ...
        resp = client_vakajarjestaja.post(
            "/api/henkilosto/v1/taydennyskoulutukset/", json.dumps(taydennyskoulutus), content_type="application/json"
        )
        assert_status_code(resp, status.HTTP_201_CREATED)
        ...
        toimipaikka_group = Group.objects.get(
            name=f"{Z4_CasKayttoOikeudet.HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA}_{toimipaikka_oid_2}"
        )
        user_toimipaikka.groups.add(toimipaikka_group)
        ...
        toimipaikka_group = Group.objects.get(
            name=f"{Z4_CasKayttoOikeudet.HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA}_{toimipaikka_oid}"
        )
        user_toimipaikka.groups.add(toimipaikka_group)
    ...
    def _get_data_ids_for_tyontekija(self, tyontekija):
        return {
            ...
            "tyoskentelypaikka_id_list": list(
                Tyoskentelypaikka.objects.filter(palvelussuhde__tyontekija=tyontekija).values_list("id", flat=True)
            ),
            "pidempi_poissaolo_id_list": list(
                PidempiPoissaolo.objects.filter(palvelussuhde__tyontekija=tyontekija).values_list("id", flat=True)
            ),
            "tutkinto_id_list": list(
                Tutkinto.objects.filter(vakajarjestaja=tyontekija.vakajarjestaja, henkilo=tyontekija.henkilo).values_list(
                    "id", flat=True
                )
            ),
            "taydennyskoulutus_tyontekija_id_list": list(
                TaydennyskoulutusTyontekija.objects.filter(tyontekija=tyontekija).values_list("id", flat=True)
            ),
            "taydennyskoulutus_id_list": list(
                Taydennyskoulutus.objects.filter(tyontekijat=tyontekija).values_list("id", flat=True)
            ),
        }
    ...
    def _verify_tyontekija_data_deletion(self, tyontekija_data, remaining_taydennyskoulutus_count=0):
        ...
        self.assertEqual(Tyoskentelypaikka.objects.filter(id__in=tyontekija_data["tyoskentelypaikka_id_list"]).count(), 0)
        self.assertEqual(PidempiPoissaolo.objects.filter(id__in=tyontekija_data["pidempi_poissaolo_id_list"]).count(), 0)
        self.assertEqual(Tutkinto.objects.filter(id__in=tyontekija_data["tutkinto_id_list"]).count(), 0)
        self.assertEqual(
            TaydennyskoulutusTyontekija.objects.filter(id__in=tyontekija_data["taydennyskoulutus_tyontekija_id_list"]).count(), 0
        )
        self.assertEqual(
            Taydennyskoulutus.objects.filter(id__in=tyontekija_data["taydennyskoulutus_id_list"]).count(),
