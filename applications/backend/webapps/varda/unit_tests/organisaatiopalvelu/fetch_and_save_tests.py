...
from varda.models import KieliPainotus, Organisaatio, ToiminnallinenPainotus, Toimipaikka
...
class TestFetchAndSaveToimipaikkaData(TestCase):
    ...
    def test_fetch_and_save_toimipaikka_data(self):
        ...
        self.assertEqual(toimipaikka.toimintakieli_koodi, ["FI", "SV"])
        ...
        painotus_dicts = list(
            (
                ToiminnallinenPainotus.objects.all()
    ...
    def get_organisaatio_json(vakajarjestaja=False, paattymis_pvm=None, oid="1.2.246.562.10.34683023489"):
        org_json = {
            ...
            "nimet": [{"nimi": {"fi": "Päiväkoti nallekarhu"}, "alkuPvm": "2018-10-01", "version": 0}],
            "yhteystiedot": [
                {
                    "osoiteTyyppi": "kaynti",
                    "kieli": "kieli_fi#1",
