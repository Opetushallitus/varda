...
from varda.organisaatiopalvelu import get_toimipaikka_update_json, get_toimipaikka_json, update_toimipaikat_in_organisaatiopalvelu
...
class VardaOrganisaatiopalveluTests(TestCase):
    ...
    def test_organisaatio_update_json(self):
        old_toimipaikka_json = {
            ...
            "postiosoite": {"osoiteTyyppi": "posti", "yhteystietoOid": "1.2.246.562.5.46256382329", "osoite": "Jokukatu 1"},
            "ryhmatyypit": [],
            "kayttoryhmat": [],
            "lisatiedot": [],
            "kuvaus2": {},
            ...
            "nimet": [
                {"nimi": {"fi": "Päiväkoti nallekarhu"}, "alkuPvm": "2018-10-01", "version": 0},
                {
                    "nimi": {
            ...
            "kayntiosoite": {"osoiteTyyppi": "kaynti", "yhteystietoOid": "1.2.246.562.5.63222798397", "osoite": "Jokukatu 1"},
            ...
            "varhaiskasvatuksenToimipaikkaTiedot": {
                ...
                "varhaiskasvatuksenKielipainotukset": [
                    {"kielipainotus": "kieli_bh", "alkupvm": "2018-10-01", "loppupvm": "2018-10-18"},
                    {"kielipainotus": "kieli_bg", "alkupvm": "2018-10-01"},
                ],
                "varhaiskasvatuksenToiminnallinenpainotukset": [
                    {"toiminnallinenpainotus": "vardatoiminnallinenpainotus_tp01", "alkupvm": "2018-10-01"}
                ],
            },
            "version": 32,
            "piilotettu": False,
        ...
        expected_result_toimipaikka_json = {
            "oid": "1.2.246.562.10.29565860110",
            "nimi": {"fi": "Espoo", "sv": "Espoo", "en": "Espoo"},
            "alkuPvm": "2017-02-03",
            "toimipistekoodi": "",
            "tyypit": ["organisaatiotyyppi_08"],
            "vuosiluokat": [],
            ...
            "nimet": [
                {"nimi": {"fi": "Espoo", "sv": "Espoo", "en": "Espoo"}, "alkuPvm": "2018-10-01", "version": 0},
                {
                    "nimi": {
                        "fi": "Old Päiväkoti nallekarhu",
                        "sv": "Old Päiväkoti nallekarhu",
            ...
            "yhteystiedot": [
                ...
                {"email": "test1@espoo.fi", "kieli": "kieli_sv#1"},
                {"email": "test1@espoo.fi", "kieli": "kieli_en#1"},
                {"numero": "+35810123456", "tyyppi": "puhelin", "kieli": "kieli_sv#1"},
                {"numero": "+35810123456", "tyyppi": "puhelin", "kieli": "kieli_en#1"},
                {
                    "osoite": "Keilaranta 14",
                    "postinumeroUri": "posti_02100",
                    "postitoimipaikka": "Espoo",
            ...
            "varhaiskasvatuksenToimipaikkaTiedot": {
                ...
                "varhaiskasvatuksenKielipainotukset": [{"kielipainotus": "kieli_fi", "alkupvm": "2017-02-10", "loppupvm": None}],
                "varhaiskasvatuksenToiminnallinenpainotukset": [
                    {"toiminnallinenpainotus": "vardatoiminnallinenpainotus_tp01", "alkupvm": "2017-02-10", "loppupvm": None}
                ],
            },
            "version": 32,
            "piilotettu": False,
    ...
    def test_toimipaikat_organisaatiopalveluun(self):
        ...
        - GET org3 + PUT org3
        """
        responses.add(responses.POST, settings.OPINTOPOLKU_DOMAIN + "/cas/v1/tickets", json={}, status=200)
        responses.add(
            responses.GET, re.compile(self.org_palvelu_url + self.oid_regex + "\\?includeImage=false"), json={}, status=200
        )
        responses.add(responses.PUT, re.compile(self.org_palvelu_url + self.toimipaikka_1_4_regex), json={}, status=200)
        responses.add(responses.PUT, re.compile(self.org_palvelu_url + self.toimipaikka_2_regex), json={}, status=200)
        responses.add(
            responses.PUT, re.compile(self.org_palvelu_url + self.toimipaikka_6727877596658_organisaatio_oid), json={}, status=200
        )
