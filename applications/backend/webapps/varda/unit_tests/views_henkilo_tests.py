...
class VardaHenkiloViewSetTests(TestCase):
    ...
    def test_henkilo_add_no_oid_response(self):
        responses.add(responses.GET,
                      ...
                      json={"oidHenkilo": '', "hetu": '010106A991Y', "etunimet": 'Nooid', "kutsumanimi": 'Nooid', "sukunimi": 'Fromonr', "yksiloityVTJ": True},
                      status=status.HTTP_200_OK
                      )
        henkilo = {
            "henkilotunnus": "010106A991Y",
            "etunimet": "Nooid",
            "kutsumanimi": "Nooid",
            "sukunimi": "Fromonr"
        }
    ...
    def test_henkilo_change_no_oid_response(self):
        responses.add(responses.GET,
                      'https://virkailija.testiopintopolku.fi/oppijanumerorekisteri-service/henkilo/hetu=210669-043K',
                      json={"oidHenkilo": '', "hetu": '210669-043K', "etunimet": 'Pauliina', "kutsumanimi": 'Pauliina', "sukunimi": 'Virtanen', "yksiloityVTJ": True},
                      status=status.HTTP_200_OK
                      )
        henkilo = {
            "henkilotunnus": "210669-043K",
