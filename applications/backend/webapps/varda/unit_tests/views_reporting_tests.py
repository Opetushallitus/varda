...
from varda.models import (
    Henkilo, Huoltaja, Huoltajuussuhde, KieliPainotus, Lapsi, Maksutieto, Palvelussuhde, PaosToiminta,
    PidempiPoissaolo, Taydennyskoulutus, TaydennyskoulutusTyontekija, VuokrattuHenkilosto, ToiminnallinenPainotus,
    Toimipaikka, Tutkinto, Tyontekija, Tyoskentelypaikka, Organisaatio, Varhaiskasvatuspaatos, Varhaiskasvatussuhde,
    Z2_Code, Tukipaatos)
...
class VardaViewsReportingTests(TestCase):
    ...
    def test_reporting_api_kela_etuusmaksatus_aloittaneet_correct_data(self):
        ...
        assert_expected_result_in_list_of_dicts_with_slight_time_difference_allowed(
            expected_result, resp_content['results'])
    ...
    def test_reporting_api_kela_etuusmaksatus_korjaustiedot_poistetut_deleted_varhaiskasvatussuhde(self):
        ...
        deleted_vakasuhde = (Varhaiskasvatussuhde.history
                             .filter(id=vakasuhde.id, history_type='-').order_by('history_id').last())
    ...
    def test_reporting_api_kela_etuusmaksatus_korjaustiedot_poistetut_deleted_varhaiskasvatuspaatos(self):
        ...
        deleted_vakasuhde = (Varhaiskasvatussuhde.history
                             .filter(id=second_vakasuhde_id, history_type='-').order_by('history_id').last())
        deleted_vakasuhde_history_date = deleted_vakasuhde.history_date.strftime("%Y-%m-%dT%H:%M:%S.%fZ")
    ...
    def test_api_error_report_lapset_huoltajatiedot_yksityinen(self):
        ...
        # Set Maksutieto asiakasmaksu > MAXIMUM_ASIAKASMAKSU
        Maksutieto.objects.filter(huoltajuussuhteet__lapsi__in=(lapsi_yksityinen, lapsi_paos,)) \
    ...
    def test_tk_transferred_data(self):
        ...
        vuokrattu_henkilosto_id_list = list(VuokrattuHenkilosto.objects.filter(vakajarjestaja=old_vakajarjestaja)
                                            .values_list('id', flat=True))
    ...
    def test_vipunen_organisaatiot(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Organisaatio, 'vipunen/organisaatiot',
                                    None, create_dict, patch_dict)
    ...
    def test_vipunen_toimipaikat(self):
        ...
        patch_dict = {
            'toimintamuoto_koodi': 'tm02',
            'alkamis_pvm': '2022-03-02'
        }
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Toimipaikka, 'vipunen/toimipaikat',
                                    '/api/v1/toimipaikat/', create_dict, patch_dict)
    ...
    def test_vipunen_tilapainen_henkilosto(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, VuokrattuHenkilosto,
                                    'vipunen/vuokrattu-henkilosto', '/api/henkilosto/v1/tilapainen-henkilosto/',
                                    create_dict, patch_dict)
    ...
    def test_vipunen_toiminnalliset_painotukset(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, ToiminnallinenPainotus,
                                    'vipunen/toiminnallisetpainotukset', '/api/v1/toiminnallisetpainotukset/',
                                    create_dict, patch_dict)
    ...
    def test_vipunen_kielipainotukset(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, KieliPainotus, 'vipunen/kielipainotukset',
                                    '/api/v1/kielipainotukset/', create_dict, patch_dict)
    ...
    def test_vipunen_lapset(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Lapsi, 'vipunen/lapset', None,
                                    create_dict, patch_dict)
    ...
    def test_vipunen_varhaiskasvatuspaatokset(self):
        ...
        patch_dict = {
            'alkamis_pvm': '2020-10-20',
            'paattymis_pvm': '2022-03-03'
        }
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Varhaiskasvatuspaatos,
                                    'vipunen/varhaiskasvatuspaatokset', '/api/v1/varhaiskasvatuspaatokset/',
                                    create_dict, patch_dict)
    ...
    def test_vipunen_varhaiskasvatussuhteet(self):
        ...
        patch_dict = {
            'paattymis_pvm': '2021-01-02'
        }
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Varhaiskasvatussuhde,
                                    'vipunen/varhaiskasvatussuhteet', '/api/v1/varhaiskasvatussuhteet/',
                                    create_dict, patch_dict)
    ...
    def test_vipunen_maksutiedot(self):
        ...
        patch_dict = {
            'paattymis_pvm': '2023-12-31'
        }
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Maksutieto, 'vipunen/maksutiedot',
                                    '/api/v1/maksutiedot/', create_dict, patch_dict, use_api_to_create=True,
    ...
    def test_vipunen_tyontekijat(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Tyontekija, 'vipunen/tyontekijat', None,
                                    create_dict, patch_dict)
    ...
    def test_vipunen_tutkinnot(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Tutkinto, 'vipunen/tutkinnot', None,
                                    create_dict, patch_dict)
    ...
    def test_vipunen_palvelussuhteet(self):
        ...
        patch_dict = {
            'tyoaika_viikossa': '40.12',
            'tyoaika_koodi': '2'
        }
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Palvelussuhde, 'vipunen/palvelussuhteet',
                                    '/api/henkilosto/v1/palvelussuhteet/', create_dict, patch_dict)
    ...
    def test_vipunen_tyoskentelypaikat(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, Tyoskentelypaikka,
                                    'vipunen/tyoskentelypaikat', '/api/henkilosto/v1/tyoskentelypaikat/',
                                    create_dict, patch_dict)
    ...
    def test_vipunen_pidemmatpoissaolot(self):
        ...
        _test_simple_historical_api(self, 'oph_luovutuspalvelu', oph_headers, PidempiPoissaolo,
                                    'vipunen/pidemmatpoissaolot', '/api/henkilosto/v1/pidemmatpoissaolot/',
                                    create_dict, patch_dict)
    ...
    def test_vipunen_taydennyskoulutukset(self):
        ...
        resp = client_admin.post('/api/henkilosto/v1/taydennyskoulutukset/', json.dumps(create_dict),
                                 content_type='application/json')
        assert_status_code(resp, status.HTTP_201_CREATED)
        ...
        assert_status_code(client_admin.patch(f'/api/henkilosto/v1/taydennyskoulutukset/{object_id_tk}/',
                                              json.dumps(patch_dict), content_type='application/json'),
                           status.HTTP_200_OK)
        datetime_lte_2 = _get_iso_datetime_now()
        ...
        results = json.loads(resp.content)['results']
        self.assertEqual(len(results), 2)
        self.assertEqual({(object_id_tk_ty, ChangeType.DELETED.value,), (object_id_tk_ty_2, ChangeType.CREATED.value,)},
                         {(single_result['id'], single_result['action'],) for single_result in results})
        ...
        # Wait for 0.1 seconds so database action happens after datetime_gt
        time.sleep(0.1)
        assert_status_code(client_admin.delete(f'/api/henkilosto/v1/taydennyskoulutukset/{object_id_tk}/', patch_dict),
                           status.HTTP_204_NO_CONTENT)
        datetime_lte_3 = _get_iso_datetime_now()
        ...
        for base_url in (base_url_tk, base_url_tk_ty,):
    ...
    def test_vipunen_henkilot(self):
        ...
        resp = client.get(f'/api/reporting/v1/vipunen/tyontekijat/?datetime_gt={datetime_gt}'
        ...
        datetime_gt_2 = _get_iso_datetime_now()
        varhaiskasvatuspaatos_patch = {
            'paattymis_pvm': '2022-02-25'
        }
        assert_status_code(client.patch('/api/v1/varhaiskasvatuspaatokset/1:testing-varhaiskasvatuspaatos1/',
                                        varhaiskasvatuspaatos_patch), status.HTTP_200_OK)
        tyoskentelypaikka_patch = {
            'tehtavanimike_koodi': '84724'
        }
        assert_status_code(client.patch('/api/henkilosto/v1/tyoskentelypaikat/1:testing-tyoskentelypaikka1/',
                                        tyoskentelypaikka_patch), status.HTTP_200_OK)
        datetime_lte_2 = _get_iso_datetime_now()
        ...
        resp = client.get(f'/api/reporting/v1/vipunen/tyontekijat/?datetime_gt={datetime_gt_2}'
...
def _test_simple_historical_api(self, username, headers, model, historical_api_path, api_path, create_dict, patch_dict,
                                use_api_to_create=False, use_api_to_delete=False):
