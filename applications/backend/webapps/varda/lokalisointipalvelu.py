...
def update_lokalisointi_data():
    ...
    for category_key, category in LOKALISOINTIPALVELU_DICT.items():
        ...
        koodisto_obj, koodisto_created = Z2_Koodisto.objects.get_or_create(name=category_key.value, defaults={
        ...
        for lokalisointi_key, lokalisointi_value in lokalisointi_result.items():
            ...
            for translation in lokalisointi_value:
                ...
                if codetranslation_created:
                    ...
                    codetranslation_obj.name != translation['value'] or
            ...
            with transaction.atomic():
                ...
                old_translation_qs = Z2_CodeTranslation.objects.filter(
                    Q(code=code_obj) & ~Q(language__in=new_translation_list))
