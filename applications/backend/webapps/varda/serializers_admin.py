...
from varda.models import Organisaatio, Toimipaikka, Maksutieto, Henkilo, Varhaiskasvatussuhde, Tyontekija, Tyoskentelypaikka
...
class SetPaattymisPvmPostSerializer(serializers.Serializer):
    vakajarjestaja = OrganisaatioPermissionCheckedHLField(view_name="organisaatio-detail", required=False, write_only=True)
