...
from varda import (views, viewsets, viewsets_admin, viewsets_henkilosto, viewsets_julkinen, viewsets_oppija,
                   viewsets_reporting, viewsets_ui, viewsets_luovutuspalvelu)
...
router_nested_vakajarjestaja.register('error-report-organisaatio', viewsets_reporting.ErrorReportOrganisaatioViewSet, basename='error-report-organisaatio')
...
router_nested_vakajarjestaja.register(r'paos-toimipaikat', viewsets.NestedVakajarjestajaPaosToimipaikatViewSet, basename='paos-toimipaikat')
...
router_kela_reporting_v2.register(r'aloittaneet', viewsets_reporting.KelaEtuusmaksatusAloittaneetV2Viewset, basename='aloittaneet-v2')
...
router_kela_reporting_v2.register(r'korjaustiedot', viewsets_reporting.KelaEtuusmaksatusKorjaustiedotV2ViewSet, 'korjaustiedot-v2')
router_kela_reporting_v2.register(r'korjaustiedotpoistetut', viewsets_reporting.KelaEtuusmaksatusKorjaustiedotPoistetutV2ViewSet, 'korjaustiedotpoistetut-v2')
...
router_tilastokeskus_reporting.register(r'varhaiskasvatustiedot', viewsets_reporting.TkVakatiedot, basename='tk-varhaiskasvatustiedot')
router_tilastokeskus_reporting.register(r'henkilostotiedot', viewsets_reporting.TkHenkilostotiedot, basename='tk-henkilostotiedot')
...
router_vipunen_reporting.register(r'organisaatiot', viewsets_reporting.VipunenOrganisaatioViewSet, basename='vipunen-organisaatiot')
router_vipunen_reporting.register(r'vuokrattu-henkilosto', viewsets_reporting.VipunenVuokrattuHenkilostoViewSet, basename='vipunen-vuokrattu-henkilosto')
...
router_vipunen_reporting.register(r'toiminnallisetpainotukset', viewsets_reporting.VipunenToiminnallinenPainotusViewSet, basename='vipunen-toiminnallisetpainotukset')
router_vipunen_reporting.register(r'kielipainotukset', viewsets_reporting.VipunenKielipainotusViewSet, basename='vipunen-kielipainotukset')
router_vipunen_reporting.register(r'lapset', viewsets_reporting.VipunenLapsiViewSet, basename='vipunen-lapset')
router_vipunen_reporting.register(r'varhaiskasvatuspaatokset', viewsets_reporting.VipunenVarhaiskasvatuspaatosViewSet, basename='vipunen-varhaiskasvatuspaatokset')
router_vipunen_reporting.register(r'varhaiskasvatussuhteet', viewsets_reporting.VipunenVarhaiskasvatussuhdeViewSet, basename='vipunen-varhaiskasvatussuhteet')
...
router_vipunen_reporting.register(r'palvelussuhteet', viewsets_reporting.VipunenPalvelussuhdeViewSet, basename='vipunen-palvelussuhteet')
router_vipunen_reporting.register(r'tyoskentelypaikat', viewsets_reporting.VipunenTyoskentelypaikkaViewSet, basename='vipunen-tyoskentelypaikat')
router_vipunen_reporting.register(r'pidemmatpoissaolot', viewsets_reporting.VipunenPidempiPoissaoloViewSet, basename='vipunen-pidemmatpoissaolot')
router_vipunen_reporting.register(r'taydennyskoulutus-tyontekijat', viewsets_reporting.VipunenTaydennyskoulutusTyontekijaViewSet, basename='vipunen-taydennyskoulutus-tyontekijat')
router_vipunen_reporting.register(r'taydennyskoulutukset', viewsets_reporting.VipunenTaydennyskoulutusViewSet, basename='vipunen-taydennyskoulutukset')
...
router_henkilosto_v2.register(r'tyoskentelypaikat', viewsets_henkilosto.TyoskentelypaikkaV2ViewSet, basename='tyoskentelypaikat-v2')
