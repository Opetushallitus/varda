    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'vuokrattu-henkilosto',
            component: VardaHenkilostoVuokrattuComponent,
            data: {
              title: VirkailijaTranslations.vuokrattu_henkilosto,
              roles: [UserAccessKeys.vuokrattuHenkilosto]
            },
          },
          {
            path: 'tukipaatos',
            component: VardaTukipaatosComponent,
            data: {
              title: VirkailijaTranslations.tuen_tiedot,
              roles: [UserAccessKeys.tukipaatokset]
            },
          },
          {
            ...
            children: [
              {
                ...
                children: [
                  ...
                  {
                    path: 'organisaatio',
                    component: VardaPuutteellisetOrganisaatioComponent,
                    data: {
                      title: VirkailijaTranslations.vakajarjestaja,
                      toimijaRoles: [UserAccessKeys.raportit]
                    }
                  }
                ]
              },
              ...
              },
              {
                ...
                component: VardaReminderReportComponent,
                data: {
                  title: VirkailijaTranslations.request_summary,
                  toimijaRoles: [
                    UserAccessKeys.oph
