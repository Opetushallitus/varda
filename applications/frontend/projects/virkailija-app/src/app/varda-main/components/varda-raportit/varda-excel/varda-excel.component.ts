...
export const ReportTypeTranslations = {
  ...
  [ReportType.VAKATIEDOT_VOIMASSA_8Y_OLDER]: VirkailijaTranslations.excel_report_type_vakatiedot_voimassa_8y_older,
  ...
  [ReportType.TYONTEKIJATIEDOT_MAARAAIKAISET_VOIMASSA]: VirkailijaTranslations.excel_report_type_tyontekijatiedot_maaraaikaiset_voimassa,
