...
const TooltipTranslations = {
  ...
  [ReportType.VAKATIEDOT_VOIMASSA_8Y_OLDER]: VirkailijaTranslations.excel_report_type_description_vakatiedot_voimassa_8y_older,
  ...
  [ReportType.TYONTEKIJATIEDOT_MAARAAIKAISET_VOIMASSA]: VirkailijaTranslations.excel_report_type_description_tyontekijatiedot_maaraaikaiset_voimassa,
...
export class VardaExcelNewComponent implements OnInit {
  ...
  toimipaikkaSelectorReports = [
    ...
    ReportType.TYONTEKIJATIEDOT_MAARAAIKAISET_VOIMASSA.toString(),
    ReportType.TOIMIPAIKAT_VOIMASSA.toString(),
  ];
  dateSelectorReports = [
    ReportType.VAKATIEDOT_VOIMASSA.toString(),
    ReportType.VAKATIEDOT_VOIMASSA_8Y_OLDER.toString(),
    ReportType.TYONTEKIJATIEDOT_VOIMASSA.toString(),
    ReportType.TOIMIPAIKAT_VOIMASSA.toString(),
  ...
  private setToimipaikkaOptions() {
    switch (this.newReport.report_type) {
      ...
      case ReportType.TYONTEKIJATIEDOT_VOIMASSA:
        ...
        break;
      case ReportType.TYONTEKIJATIEDOT_MAARAAIKAISET_VOIMASSA:
        this.toimipaikkaOptions = this.henkilostoToimipaikkaList;
        break;
      default:
        break;
