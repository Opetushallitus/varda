...
@Component({
    ...
    styleUrls: ['./varda-henkilo-list.component.css', '../varda-main-frame.component.css'],
    standalone: false
})
export class VardaHenkiloListComponent {
  ...
  getPaosText(suhde: LapsiListDTO) {
    if (suhde.oma_organisaatio_oid) {
      return (
        suhde.oma_organisaatio_oid === this.selectedVakajarjestaja.organisaatio_oid ?
          suhde.paos_organisaatio_nimi : suhde.oma_organisaatio_nimi
      );
    }
  }
}
