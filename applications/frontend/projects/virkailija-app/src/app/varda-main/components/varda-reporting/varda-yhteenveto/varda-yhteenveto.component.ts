...
export class VardaYhteenvetoComponent implements OnInit {
  ...
  datasourceTuenTiedot: Array<YhteenvetoElement> = [];
  ...
  fetchYhteenveto(): void {
    this.koosteService.getYhteenveto(this.selectedVakajarjestaja.id).subscribe(yhteenveto => {
      ...
      this.datasourceTuenTiedot = [
        [this.i18n.yhteenveto_tuen_tiedot_kunnallinen_tt_01, yhteenveto.tuen_tiedot_kunnallinen_tt_01,
          this.i18n.yhteenveto_tooltip_tuen_tiedot_kunnallinen_tt_01, 'tuen_tiedot_kunnallinen_tt_01'],
        [this.i18n.yhteenveto_tuen_tiedot_kunnallinen_tt_02, yhteenveto.tuen_tiedot_kunnallinen_tt_02,
          this.i18n.yhteenveto_tooltip_tuen_tiedot_kunnallinen_tt_02, 'tuen_tiedot_kunnallinen_tt_02'],
        [this.i18n.yhteenveto_tuen_tiedot_kunnallinen_tt_03, yhteenveto.tuen_tiedot_kunnallinen_tt_03,
          this.i18n.yhteenveto_tooltip_tuen_tiedot_kunnallinen_tt_03, 'tuen_tiedot_kunnallinen_tt_03'],
        [this.i18n.yhteenveto_tuen_tiedot_yksityinen_tt_01, yhteenveto.tuen_tiedot_yksityinen_tt_01,
          this.i18n.yhteenveto_tooltip_tuen_tiedot_yksityinen_tt_01, 'tuen_tiedot_yksityinen_tt_01'],
        [this.i18n.yhteenveto_tuen_tiedot_yksityinen_tt_02, yhteenveto.tuen_tiedot_yksityinen_tt_02,
          this.i18n.yhteenveto_tooltip_tuen_tiedot_yksityinen_tt_02, 'tuen_tiedot_yksityinen_tt_02'],
        [this.i18n.yhteenveto_tuen_tiedot_yksityinen_tt_03, yhteenveto.tuen_tiedot_yksityinen_tt_03,
          this.i18n.yhteenveto_tooltip_tuen_tiedot_yksityinen_tt_03, 'tuen_tiedot_yksityinen_tt_03']
      ].map(item => this.createDatasourceElement(item[0] as string, item[1] as number, item[2] as string,
        item[3] as string));

      this.is_active_timeframe = yhteenveto.is_active_timeframe;
