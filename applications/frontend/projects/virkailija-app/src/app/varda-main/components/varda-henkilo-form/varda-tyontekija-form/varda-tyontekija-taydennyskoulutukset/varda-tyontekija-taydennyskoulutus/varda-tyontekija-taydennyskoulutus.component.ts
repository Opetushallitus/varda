...
export class VardaTyontekijaTaydennyskoulutusComponent
  extends VardaFormAccordionAbstractComponent<TyontekijaTaydennyskoulutus>
  ...
  initForm() {
    this.formGroup = new FormGroup({
      ...
      koulutuspaivia: new FormControl(
        this.currentObject?.koulutuspaivia,
        [
          Validators.required,
          Validators.min(0.5),
          Validators.max(160),
      ...
      suoritus_pvm: new FormControl(
        this.currentObject
          ? DateTime.fromFormat(this.currentObject.suoritus_pvm, VardaDateService.vardaApiDateFormat, VardaDateService.uiDateTimezone)
          : null,
        Validators.required
      ),
        ...
        observable.pipe(
          ...
          next: (result: VardaTaydennyskoulutusDTO) => {
            ...
            this.currentObject = {
              ...
              muutos_pvm: result.muutos_pvm,
              luonti_pvm: result.luonti_pvm
            };
  ...
  deleteTaydennyskoulutus(): void {
    const taydennyskoulutusJson: VardaTaydennyskoulutusDTO = {
      ...
      suoritus_pvm: this.formGroup.value.suoritus_pvm.toFormat(VardaDateService.vardaApiDateFormat),
