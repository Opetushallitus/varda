...
export class VardaVakajarjestajaService {
  ...
  setVakajarjestajat(userVakaJarjestajat: Array<VardaVakajarjestajaUi>): void {
    ...
    const selectedVakajarjestaja = userVakaJarjestajat.find(
      vakajarjestaja => vakajarjestaja.organisaatio_oid === storageVakajarjestaOID
    ) || userVakaJarjestajat[0];
   ...
   *
   * @remarks for more detailed filtering use e.g. authService.getAuthorizedToimipaikat(toimipaikat, SaveAccess)
   */
