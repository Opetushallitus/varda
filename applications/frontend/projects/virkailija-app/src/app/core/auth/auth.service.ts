...
export class AuthService {
  ...
  getAuthorizedToimipaikat(
    toimipaikat: Array<VardaToimipaikkaMinimalDto>, hasAccess?: SaveAccess | ViewAccess
  ): Array<VardaToimipaikkaMinimalDto> {
    return toimipaikat.filter((toimipaikka: VardaToimipaikkaMinimalDto) => {
      ...
      switch (hasAccess) {
        case SaveAccess.kaikki:
          return (
            access.tyontekijatiedot.tallentaja ||
            access.taydennyskoulutustiedot.tallentaja ||
            access.huoltajatiedot.tallentaja ||
            access.lapsitiedot.tallentaja
          );
        ...
        case undefined:
          return (
            access.tyontekijatiedot.katselija ||
            access.taydennyskoulutustiedot.katselija ||
            access.huoltajatiedot.katselija ||
            access.lapsitiedot.katselija
          );
        default:
  ...
  getUserAccess(toimipaikkaOID?: string): UserAccess {
    ...
    const access: UserAccess = {
      ...
      tyontekijatiedot: {
        katselija: getRoles(
          VardaKayttooikeusRoles.HENKILOSTO_TYONTEKIJA_TALLENTAJA, VardaKayttooikeusRoles.HENKILOSTO_TYONTEKIJA_KATSELIJA
        ),
        tallentaja: getRoles(VardaKayttooikeusRoles.HENKILOSTO_TYONTEKIJA_TALLENTAJA)
      },
      vuokrattuHenkilosto: {
        katselija: getRoles(VardaKayttooikeusRoles.HENKILOSTO_VUOKRATTU_TALLENTAJA, VardaKayttooikeusRoles.HENKILOSTO_VUOKRATTU_KATSELIJA),
        tallentaja: getRoles(VardaKayttooikeusRoles.HENKILOSTO_VUOKRATTU_TALLENTAJA)
      },
      tukipaatokset: {
        katselija: getRoles(VardaKayttooikeusRoles.TUEN_TIEDOT_TALLENTAJA, VardaKayttooikeusRoles.TUEN_TIEDOT_KATSELIJA),
        tallentaja: getRoles(VardaKayttooikeusRoles.TUEN_TIEDOT_TALLENTAJA)
      },
      taydennyskoulutustiedot: {
        katselija: getRoles(
          VardaKayttooikeusRoles.HENKILOSTO_TAYDENNYSKOULUTUS_TALLENTAJA, VardaKayttooikeusRoles.HENKILOSTO_TAYDENNYSKOULUTUS_KATSELIJA
        ),
    ...
    if (toimipaikka && toimipaikka.paos_organisaatio_nimi) {
      ...
      access.vuokrattuHenkilosto = { katselija: false, tallentaja: false };
