...
export const VARDA_DATEPICKER_DATE_FORMATS = ['d.M.yyyy', 'dd.MM.yyyy'];
...
export const VARDA_DATEPICKER_FORMATS = {
  parse: {
    dateInput: VARDA_DATEPICKER_DATE_FORMATS
  },
  display: {
...
@Component({
    ...
    providers: [
        ...
        },
        {
            ...
            useValue: VARDA_DATEPICKER_FORMATS
        }
    ],
...
export class VardaDatepickerComponent implements OnInit, OnChanges, ControlValueAccessor, Validator {
  ...
  disabled = false;
  matDateModel: DateTime = DateTime.now();
