...
def fix_maksutieto_permissions_for_paos_children():
    ...
    from varda.models import Maksutieto, Lapsi, Toimipaikka
    from varda.permission_groups import assign_paos_permissions, assign_toimipaikka_paos_permissions
    ...
    for maksutieto in paos_maksutiedot:
        try:
            ...
            toimipaikka_qs = Toimipaikka.objects.filter(varhaiskasvatussuhteet__varhaiskasvatuspaatos__lapsi=lapsi_obj)
            ...
            for toimipaikka in toimipaikka_qs:
                if related_object_validations.toimipaikka_is_valid_to_organisaatiopalvelu(toimipaikka_obj=toimipaikka):
                    assign_toimipaikka_paos_permissions(toimipaikka.organisaatio_oid, oma_organisaatio_oid, Maksutieto, maksutieto)
