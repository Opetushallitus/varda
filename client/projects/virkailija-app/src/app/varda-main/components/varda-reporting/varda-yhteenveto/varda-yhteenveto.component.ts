  ...
  fetchYhteenveto(): void {
    this.koosteService.getYhteenveto(this.selectedVakajarjestaja.id).subscribe(yhteenveto => {
      ...
      this.datasourceTyontekijat = [
        ...
        [this.i18n.yhteenveto_tilapainen_henkilosto_maara_kuluva_vuosi,
          yhteenveto.tilapainen_henkilosto_maara_kuluva_vuosi,
          this.i18n.yhteenveto_tooltip_tilapainen_henkilosto_maara_kuluva_vuosi,
          'tilapainen_henkilosto_maara_kuluva_vuosi'],
        [this.i18n.yhteenveto_tilapainen_henkilosto_tunnit_kuluva_vuosi,
          yhteenveto.tilapainen_henkilosto_tunnit_kuluva_vuosi,
          this.i18n.yhteenveto_tooltip_tilapainen_henkilosto_tunnit_kuluva_vuosi,
          'tilapainen_henkilosto_tunnit_kuluva_vuosi'],
      ].map(item => this.createDatasourceElement(item[0] as string, item[1] as number, item[2] as string,
        item[3] as string));
