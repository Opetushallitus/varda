...
export class VardaSetPaattymisPvmComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.params = {
      ...
      paattymis_pvm: this.dateService.momentToVardaDate(this.date)
    };
  }
  ...
  setPaattymisPvm() {
    ...
    this.params.paattymis_pvm = this.dateService.momentToVardaDate(this.date);
  ...
  getUIDate(momentDate: Moment) {
    return this.dateService.momentToUiDate(momentDate);
  }
