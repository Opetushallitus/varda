import { Component, OnInit, OnChanges, Input, Output, ViewChildren, EventEmitter, ViewChild, ElementRef, AfterViewInit } from '@angular/core';
...
export class VardaPoissaoloComponent implements OnInit, AfterViewInit {
